@extends('layouts.landing', ['title' => 'Law Students || Criminal Law || Our Blog 02'])
  ...
  <div class="blog4-section-area sp1">
    ...
    <div class="row">
      ...
      <div class="blog4-boxarea">
        ...
        <a href="{{ route('second', ['blog', 'single']) }}">Your Shield in Legal Battles: Premier Criminal Law & Lawyer Defense Counsel at Service</a>
        ...
        <a href="{{ route('second', ['blog', 'single']) }}" class="readmore">Learn More <i class="fa-light fa-arrow-right"></i></a>
        </div>
      </div>
      </div>
      ...
      <div class="blog4-boxarea">
        ...
        <a href="{{ route('second', ['blog', 'single']) }}">Empowering Your Defense: Trustworthy Law Criminal Lawyers Protecting Your Rights</a>
        <p>Our team of dedicated criminal defense attorneys is here to has provide unwavering support and expert legal guidance lawyer.</p>
      ...
      <div class="blog4-boxarea">
        ...
        <a href="{{ route('second', ['blog', 'single']) }}">Defending Futures: Seasoned Criminal Lawyer Defense Lawyers Ready to Fight for You</a>
        <p>Our team of dedicated criminal defense attorneys is here to has provide unwavering support and expert legal guidance lawyer.</p>
        <a href="{{ route('second', ['blog', 'single']) }}" class="readmore">Learn More <i class="fa-light fa-arrow-right"></i></a>
        </div>
      </div>
      ...
      <div class="blog4-boxarea">
        ...
        <a href="{{ route('second', ['blog', 'single']) }}">Navigating Legal Storms: Premier Criminal Defense Lawyers Ensuring Your Rights</a>
        <p>Our team of dedicated criminal defense attorneys is here to has provide unwavering support and expert legal guidance lawyer.</p>
        <a href="{{ route('second', ['blog', 'single']) }}" class="readmore">Read More <i class="fa-light fa-arrow-right"></i></a>
        </div>
      </div>
