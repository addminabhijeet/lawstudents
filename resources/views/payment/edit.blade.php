                            ...
                            <tbody>
                                ...
                                <tr class="single-item">
                                    ...
                                    <td class="bg-gray-100 w-25"><input type="number" name="grand_total"
                                            id="total_amount" value="{{ old('grand_total', $payment->grand_total) }}"
                                            readonly></td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="card stretch stretch-full">
                <div class="card-body">
                    ...
                    <div
                        ...
                        <input class="form-check-input" type="checkbox" name="client_note_enabled" value="1"
                            {{ $payment->client_note_enabled ? 'checked' : '' }}>
                    </div>
                    <div
