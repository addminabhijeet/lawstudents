@extends('layouts.base', ['title' => 'Lawsy || Divorce Law || 01', 'logo10' => true])

@section('content')
  @include('layouts.partials.loader', ['loader' => 'preloader5'])
  ...
  <div class="welcome5-scetion-area">
    ...
    <div class="row">
      ...
      <div class="welcome5-textarea">
        ...
        <a href="{{ route('second', ['contact', 'v1']) }}" class="welcome5-btn">Begin A Transformation <i class="fa-regular fa-arrow-right"></i></a>
        </div>
      </div>
      </div>
      <div class="col-lg-2">
  ...
  <div class="about5-sction-area sp1">
    ...
    <div class="row align-items-center">
      ...
      <div class="about5-content-area">
        ...
        <a href="{{ route('second', ['pages', 'about']) }}" class="welcome5-btn">Speak with a Lawyers <i class="fa-regular fa-arrow-right"></i></a>
        </div>
      </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="service5-carousel-area owl-carousel">
        ...
        <div class="service5-content-area">
          ...
          <a href="{{ route('second', ['service', 'single']) }}">Divorce Consultation</a>
        </div>
        <div class="service-content">
          ...
          <a href="{{ route('second', ['service', 'single']) }}" class="learnmore">Read More <i class="fa-regular fa-arrow-right"></i></a>
        </div>
        </div>
        ...
        <div class="service5-content-area">
          <img src="/img/icons/service5-h1.svg" alt="" class="home-icon" />
          <a href="{{ route('second', ['service', 'single']) }}">Child Custody & Support</a>
        </div>
        <div class="service-content">
          <img src="/img/icons/service5-h1.svg" alt="" class="home-icon" />
          <a href="{{ route('second', ['service', 'single']) }}">Child Custody & Support</a>
        ...
        <div class="service-content">
          <img src="/img/icons/service5-h1.svg" alt="" class="home-icon" />
          <a href="{{ route('second', ['service', 'right']) }}">Divorce Consultation</a>
          <p>Our mission at Defend Right Landing to Pages is to provide comprehensive and reliable digital solutions for criminal.</p>
          <a href="{{ route('second', ['service', 'single']) }}" class="learnmore">Read More <i class="fa-regular fa-arrow-right"></i></a>
        </div>
        </div>
      ...
      <div class="div text-center">
        <a href="{{ route('second', ['service', 'service1']) }}" class="welcome5-btn">View More Services <i class="fa-regular fa-arrow-right"></i></a>
      </div>
      </div>
    </div>
    </div>
  ...
  <div class="casestudy5-section-area sp1">
    ...
    <div class="row">
      ...
      <div class="casestudy5-all-area">
        ...
        <a href="{{ route('second', ['service', 'single']) }}">A Successful Custody Resolution – How we are Secured the best Interests of the Children.</a>
      ...
      <div class="col-lg-12" data-aos="fade-down" data-aos-duration="1000">
        ...
        <div class="testimonial6-box">
          ...
          <div class="tesimonial6-man-info">
            ...
            <div class="testimonial6-text">
            <a href="{{ route('second', ['pages', 'team1']) }}">Alex Stokes</a>
            <p>10 October 2024</p>
            </div>
          </div>
          <img src="/img/icons/quito5.svg" alt="" class="quito-img1" />
