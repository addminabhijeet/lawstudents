                        ...
                        <aside class="slide-bar slide-bar2">
                            ...
                            <div class="sidebar-info sidebar-info2">
                                ...
                                <div class="theme-btnarea">
                                    <a href="#" class="welconme-btn2">Contact Us <span><i class="fa-regular fa-angle-left"></i></span></a>
                                </div>
                            ...
                            <nav class="side-mobile-menu">
                                ...
                                <ul id="mobile-menu-active">
                                    ...
                                    <li><a class="scrollspy-btn" href="#">Get in touch</a></li>
                                </ul>
                            </nav>
                        </aside>
...
<div class="mobile-sidebar sidebar2">
    ...
    <div class="mobile-nav">
        ...
        <ul class="mobile-nav-list">
            ...
            <li><a href="#">Our Services</a>
                <ul class="sub-menu">
                    <li><a href="{{ route('second', ['service', 'service1']) }}">Service One</a></li>
                    <li><a href="{{ route('second', ['service', 'service2']) }}">Service Two</a></li>
                    <li><a href="{{ route('second', ['service', 'left']) }}">Service Details Left</a></li>
                    <li><a href="{{ route('second', ['service', 'right']) }}">Service Details Right</a></li>
                    <li><a href="{{ route('second', ['service', 'single']) }}">Service Single</a></li>
                </ul>
            </li>
            ...
            <li>
                <a href="#">Countries</a>
                <ul class="sub-menu">
                    <li><a href="#">Country One</a></li>
                    <li><a href="#">Country Details Left</a></li>
                    <li><a href="#">Country Details Right</a></li>
                    <li><a href="#">Country Single</a></li>
                </ul>
            </li>
            <li><a href="#">Coaching</a>
                <ul class="sub-menu">
                    <li><a href="#">Coaching One</a></li>
                    <li><a href="#">Coaching Details Left</a></li>
                    <li><a href="#">Coaching Details Right</a></li>
                    <li><a href="#">Coaching Single</a></li>
                </ul>
            </li>
            <li><a href="#">Blogs</a>
                <ul class="sub-menu">
                    <li><a href="{{ route('second', ['blog', 'blog1']) }}">Blog One</a></li>
                    <li><a href="{{ route('second', ['blog', 'left']) }}">Blog Details Left</a></li>
                    <li><a href="{{ route('second', ['blog', 'right']) }}">Blog Details Right</a></li>
                    <li><a href="{{ route('second', ['blog', 'single']) }}">Blog Single</a></li>
                </ul>
            </li>
            <li><a href="{{ route('second', ['contact', 'v1']) }}">Contact</a></li>
        ...
        <div class="allmobilesection">
            <a href="{{ route('second', ['contact', 'v1']) }}" class="welconme-btn2">Get Started <span><i class="fa-regular fa-angle-left"></i></span></a>
