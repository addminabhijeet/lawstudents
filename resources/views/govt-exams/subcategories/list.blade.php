            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        <a href="{{ route('admin.addgovtexamsubcategory') }}" class="btn btn-primary">
                            <i class="feather-plus me-2"></i>
                            <span>Add Govt. Examination Subcategories</span>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="card stretch stretch-full">
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover" id="govtExamSubcategoriesList">
                                    <thead>
                                        <tr>
                                            <th class="wd-30">#</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    <a href="{{ route('admin.editgovtexamsubcategory', $subcategorie->id) }}" class="btn btn-sm btn-primary">Edit</a>

                                                    <form method="POST" action="{{ route('admin.deletegovtexamsubcategoryfile', $subcategorie->id) }}" class="d-inline">
                                                        @csrf
