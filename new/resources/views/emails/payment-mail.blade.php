                ...
                <table class="container" style="border-top:4px solid #FA0F00;">
                    ...
                    <tr>
                        <td class="content intro" style="padding-top:0; color:#555;">
                            Hello {{ $payment->student->name }},<br><br>
                        ...
                        <td class="content" style="padding-top:0;">
                            <table width="100%" cellpadding="14">
                                ...
                                <tr>
                                    ...
                                    <td class="value">{{ $payment->student->email }}</td>
                                </tr>

                                <tr class="row-alt">
                                    <td class="label">Issue Date</td>
                                    <td class="value">{{ $payment->issue_date }}</td>
                                </tr>

                                <tr>
                                    <td class="label">Due Date</td>
                                    <td class="value">{{ $payment->due_date }}</td>
                                </tr>

                                <tr class="row-alt">
                                    <td class="label">Sub Total</td>
                                    <td class="value">{{ $payment->sub_total }}</td>
                                </tr>

                                <tr>
                                    <td class="label">Tax</td>
                                    <td class="value">{{ $payment->tax_amount }}</td>
                                </tr>

                                <tr class="row-alt">
                                    <td class="label">Discount</td>
                                    <td class="value">{{ $payment->discount }}</td>
                                </tr>

                                <tr>
                                    <td class="label">Grand Total</td>
                                    <td class="value">{{ $payment->grand_total }}</td>
                                </tr>

                                <tr class="row-alt">
                                    <td class="label">Paid Amount</td>
                                    <td class="value">{{ $payment->paid_amount }}</td>
                                </tr>

                                <tr>
                                    <td class="label">Remaining</td>
                                    <td class="value">{{ $payment->remaining_amount }}</td>
                                </tr>

                                <tr class="row-alt">
                                    <td class="label">Status</td>
                                    <td class="value">{{ ucfirst($payment->payment_status) }}</td>
                                </tr>

                                <tr>
                                    <td class="label">Note</td>
                                    <td class="value">{{ $payment->invoice_note }}</td>
                                </tr>
