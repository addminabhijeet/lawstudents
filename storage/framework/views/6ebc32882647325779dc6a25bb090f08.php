                    ...
                    <div class="row note-has-grid" id="note-full-container">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $category->courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = $wishlistedNotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        ...
                                        <div class="card card-body mb-4 shadow-sm border-0 rounded-3 position-relative">
                                            ...
                                            <p class="fs-11 text-muted mb-2">
                                                Course: <b><?php echo e($course->title); ?></b>
                                            </p>
                        ...
                        <?php if($categories->pluck('courses')->flatten()->pluck('notes')->flatten()->filter(fn($n) => $n->wishlists->where('student_id', auth()->id())->count() > 0)->isEmpty()): ?>
...
<?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/notesstu/list.blade.php ENDPATH**/ ?>