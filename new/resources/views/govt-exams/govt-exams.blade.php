...
@section('content')
<!-- ===== MODERN MOBILE REDESIGN FOR GOVT EXAMS PAGE ======= -->
<style>
    ...
    * {
    ...
    /* ===== HEADING STYLES FOR GOVT EXAMS PAGE (DESIGN SYSTEM EXACT) ===== */
    h1 {
                    ...
                    <div id="cat{{ $category->id }}" class="accordion-content" style="max-height:1000px;">
                        ...
                        <div style="margin:10px; border:1px dashed #ccc; border-radius:6px; overflow:hidden;">
                            ...
                            <div id="sub{{ $sub->id }}" class="accordion-content" style="padding:10px; max-height:1000px;">
                                ...
                                <!-- GOVT EXAM ENTRY -->
                                <div data-govtexam-id="{{ $exam->id }}" style="margin-bottom:10px; padding:10px; border:1px solid #eee; border-radius:6px;">
