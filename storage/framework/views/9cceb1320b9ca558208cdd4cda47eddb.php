...
<script src="<?php echo e(asset('assets/vendors/js/select2.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/vendors/js/select2-active.min.js')); ?>"></script>
<!--! END: Vendors JS !-->

<!--! BEGIN: Apps Init  !-->
<script src="<?php echo e(asset('assets/js/common-init.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/leads-view-init.min.js')); ?>"></script>
<!--! END: Apps Init !-->
...
<?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/layouts/partials/student/theme.blade.php ENDPATH**/ ?>