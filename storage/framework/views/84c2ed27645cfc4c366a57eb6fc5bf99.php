        ...
        <div class="row">
            <div style="width:100%; max-width:1100px; margin:auto;">
                            ...
                            <div style="position:relative;">
                                ...
                                <div id="categoryDropdownMenu"
                                    ...
                                    <div style="max-height:380px; overflow-y:auto;">
                                        ...
                                        <?php echo $__env->make('course.partials.category-tree', ['categories' => $categories, 'depth' => 0], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="courses-container" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 25px; margin-bottom: 40px;">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $allCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="course-card-item" data-category-id="<?php echo e($course->category_id); ?>" data-course-id="<?php echo e($course->id); ?>"
                        ...
                        <div style="width:100%; height:180px; overflow:hidden; background:#f0f0f0;">
                            <img src="<?php echo e(asset('storage/app/public/' . $course->thumbnail)); ?>" alt="<?php echo e($course->title); ?>"
                        ...
                        <div style="padding:16px; flex:1; display:flex; flex-direction:column; justify-content:space-between;">
                            ...
                            <div>
                                ...
                                <div style="font-size:13px; color:#6b7280; margin-bottom:8px; display:flex; align-items:center; gap:6px;">
                                    ...
                                    Notes: <?php echo e($course->notes->count()); ?>

                                </div>

                                <div style="font-size:13px; color:#6b7280; margin-bottom:8px;">
                                    Price: <span style="font-weight:700; color:#1f2937;">₹<?php echo e(number_format($course->price ?? 0, 2)); ?></span>
                                </div>

                                <?php if($course->discount): ?>
                                <div style="font-size:13px; color:#6b7280;">
                                    Discount: <span style="font-weight:700; color:#ef4444;">₹<?php echo e(number_format($course->discount ?? 0, 2)); ?></span>
                                </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div style="margin-top:16px; display:flex; gap:10px;">
                                ...
                                <a href="<?php echo e(asset('storage/app/public/' . $course->brochure)); ?>" target="_blank"
                ...
                <div style="display: flex; justify-content: center; align-items: center; margin-top: 40px;">
                    <nav aria-label="Page navigation" style="width: 100%;">
                        <ul class="pagination" style="display: flex; justify-content: center; align-items: center; gap: 5px; margin: 0; padding: 0; list-style: none;">
                            ...
                            <?php else: ?>
                            <li class="page-item">
                                <a href="<?php echo e($allCourses->previousPageUrl()); ?>"
                            ...
                            <!-- Page Numbers -->
                            <?php $__currentLoopData = $allCourses->getUrlRange(1, $allCourses->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php elseif($page == 1 || $page == $allCourses->lastPage() || abs($page - $allCourses->currentPage()) <= 1): ?>
                                <li class="page-item">
                                ...
                                <?php elseif($page == 2 && $allCourses->currentPage() > 3): ?>
                                <li style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px;">
                                    <span style="color: #9ca3af;">...</span>
                                </li>
                                <?php elseif($page == $allCourses->lastPage() - 1 && $allCourses->currentPage() < $allCourses->lastPage() - 2): ?>
                                <li style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px;">
                                    <span style="color: #9ca3af;">...</span>
                                </li>
                                <?php endif; ?>
                            ...
                            <li class="page-item">
                                <a href="<?php echo e($allCourses->nextPageUrl()); ?>"
                                    style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px;
                                            border: 2px solid #e5e7eb; border-radius: 6px; color: #374151; text-decoration: none;
                                            transition: all 0.3s ease; cursor: pointer;"
                                    onmouseover="this.style.borderColor='#128C7E'; this.style.color='#128C7E';"
...
<script>
    ...
    function searchCourses(query) {
        ...
        fetch(`<?php echo e(route('frontend.coursesearch')); ?>?q=${encodeURIComponent(query)}`)
...
<?php echo $__env->make('layouts.landing', ['title' => 'Courses'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/course/course.blade.php ENDPATH**/ ?>