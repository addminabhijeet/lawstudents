                ...
                <div class="content-area-body pb-0">
                    <div class="row note-has-grid" id="note-full-container">
                        ...
                        <div
                            ...
                            <div class="card card-body mb-4 stretch stretch-full">
                                ...
                                <h5 class="note-title text-truncate w-75 mb-1"
                                    data-noteheading="Book a Ticket for Movie">Book
                                ...
                                <div class="note-content flex-grow-1">
                                    <p class="text-muted note-inner-content text-truncate-3-line"
                                        ...
                                        harum
                                        excepturi laudantium eum earum accusantium labore libero maiores illo soluta.
                                    </p>
                                </div>
                        ...
                        <div
                            ...
                            <div class="card card-body mb-4 stretch stretch-full">
                                <span class="side-stick"></span>
                                <h5 class="note-title text-truncate w-75 mb-1" data-noteheading="Go for lunch">Go for
                                    lunch <i class="point bi bi-circle-fill ms-1 fs-7"></i></h5>
                        ...
                        <div
                            ...
                            <div class="card card-body mb-4 stretch stretch-full">
                                <span class="side-stick"></span>
                                <h5 class="note-title text-truncate w-75 mb-1"
                                    data-noteheading="Meeting with Mr.Jojo">Meeting
                        ...
                        <div
                            ...
                            <div class="card card-body mb-4 stretch stretch-full">
                                <span class="side-stick"></span>
                                <h5 class="note-title text-truncate w-75 mb-1"
                                    data-noteheading="Give Review for design">Give
                        ...
                        <div
                            ...
                            <div class="card card-body mb-4 stretch stretch-full">
                                <span class="side-stick"></span>
                                <h5 class="note-title text-truncate w-75 mb-1" data-noteheading="Launch new template">
                                    Launch
                        ...
                        <div
                            ...
                            <div class="card card-body mb-4 stretch stretch-full">
                                <span class="side-stick"></span>
                                <h5 class="note-title text-truncate w-75 mb-1" data-noteheading="Change a Design">
                                    Change a
                        ...
                        <div
                            ...
                            <div class="card card-body mb-4 stretch stretch-full">
                                <span class="side-stick"></span>
                                <h5 class="note-title text-truncate w-75 mb-1"
                                    data-noteheading="Give review for foods">Give
                        ...
                        <div
                            ...
                            <div class="card card-body mb-4 stretch stretch-full">
                                <span class="side-stick"></span>
                                <h5 class="note-title text-truncate w-75 mb-1"
                                    data-noteheading="Give salary to employee">Give
