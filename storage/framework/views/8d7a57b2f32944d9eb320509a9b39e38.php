...
<?php $__env->startSection('content'); ?>
  <?php echo $__env->make('layouts.partials.loader', ['loader' => 'preloader4'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  ...
  <div class="welcome2-section-area">
    ...
    <div class="row align-items-center">
      ...
      <div class="welcome-header2-text">
        ...
        <a href="<?php echo e(route('second', ['contact', 'v1'])); ?>" class="welconme-btn2">Download Tax Guides <span><i class="fa-regular fa-angle-right"></i></span></a>
        </div>
      </div>
      </div>
      <div class="col-lg-6">
  ...
  <div class="about-section-area sp1">
    ...
    <div class="row align-items-center">
      ...
      <div class="about2-textarea">
        ...
        <a href="<?php echo e(route('second', ['pages', 'about'])); ?>" class="welconme-btn2">About Us <span><i class="fa-regular fa-angle-right"></i></span></a>
        </div>
      </div>
      </div>
    </div>
  ...
  <div class="service2-section-area sp3">
    ...
    <div class="row align-items-center">
      ...
      <div class="service2-header-text">
        ...
        <a href="<?php echo e(route('second', ['service', 'service1'])); ?>" class="welconme-btn2">View Our Services <span><i class="fa-regular fa-angle-right"></i></span></a>
        </div>
      </div>
      </div>
      <div class="col-lg-8">
      <div class="service2-boxarea">
        ...
        <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-duration="500" data-aos-easing="linear">
          ...
          <div class="tax-content">
            <a href="<?php echo e(route('second', ['service', 'single'])); ?>">Estate Planning & Taxation</a>
            <p>
            From understanding the latest tax code <br /> change to exploring tax planning strategies.
            </p>
          </div>
          <a href="<?php echo e(route('second', ['service', 'single'])); ?>" class="learn-more">Learn More<i class="fa-regular fa-arrow-right"></i></a>
          <div class="arrow-service">
            <span><a href="<?php echo e(route('second', ['service', 'single'])); ?>"><img src="/img/icons/arrow_right.svg" alt="" /></a></span>
          </div>
          </div>
        </div>
  ...
  <div class="team2-section-area sp3">
    ...
    <div class="row">
      ...
      <div class="team2-parent-boxarea">
        ...
        <div class="teamsname">
          <a href="<?php echo e(route('second', ['pages', 'team1'])); ?>">Alex Fargusion</a>
      ...
      <div class="team2-parent-boxarea">
        ...
        <div class="team2-textarea">
        <div class="teamsname">
          <a href="<?php echo e(route('second', ['pages', 'team1'])); ?>">Richad Stones</a>
          <p>Senior Attorneys</p>
        </div>
        <div class="shareicon">
          <a href="#"><i class="fa-light fa-share-nodes"></i></a>
      ...
      <div class="team2-parent-boxarea">
        ...
        <div class="team2-textarea">
        <div class="teamsname">
          <a href="<?php echo e(route('second', ['pages', 'team1'])); ?>">Pep Gurdiola</a>
          <p>Tax Analysis</p>
        </div>
        <div class="shareicon">
          <a href="#"><i class="fa-light fa-share-nodes"></i></a>
  ...
  <div class="testimonial2-section-area sp1">
    ...
    <div class="row align-items-center">
      ...
      <div class="testimonial2-header">
        ...
        <div class="div" data-aos="fade-up" data-aos-duration="1200">
        <a href="<?php echo e(route('second', ['pages', 'testimonial1'])); ?>" class="welconme-btn2">Read More Reviews <span><i class="fa-regular fa-angle-right"></i></span></a>
        </div>
      </div>
      </div>
  ...
  <div class="blog1-section-area blog2-section sp1">
    ...
    <div class="col-lg-12" data-aos="fade-up" data-aos-duration="1400">
      ...
      <a href="<?php echo e(route('second', ['blog', 'blog1'])); ?>" class="welconme-btn2">Read More & Articles <span><i class="fa-regular fa-angle-right"></i></span></a>
      </div>
    </div>
    </div>
  </div>
...
<?php echo $__env->make('layouts.base', ['title' => 'Lawsy || Tax Law || 02', 'logo4' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Lawsy\resources\views/demo/index3.blade.php ENDPATH**/ ?>