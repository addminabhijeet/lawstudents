...
<body>
            ...
            <div class="navbar-content">
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link"
                                    href="<?php echo e(route('student.viewstudent')); ?>">Registration</a></li>
                            <li class="nxl-item"><a class="nxl-link"
                                    href="<?php echo e(route('student.viewadmission')); ?>">Addmission</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link"
                                    href="<?php echo e(route('student.viewpayment')); ?>">Payment</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="<?php echo e(route('student.viewidcard')); ?>">View</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="<?php echo e(route('student.listcourse')); ?>">List</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link"
                                    href="<?php echo e(route('student.listnotes')); ?>">Favorite</a></li>
                        </ul>
                    </li>
                ...
                <div class="d-flex align-items-center">
                            ...
                            <div class="search-items-wrapper">
                                ...
                                <div class="users-result px-4 py-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image rounded">
                                                <img src="<?php echo e(asset('assets/images/avatar/1.png')); ?>" alt=""
                                                    class="img-fluid">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image rounded">
                                                <img src="<?php echo e(asset('assets/images/avatar/2.png')); ?>" alt=""
                                                    class="img-fluid">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image rounded">
                                                <img src="<?php echo e(asset('assets/images/avatar/3.png')); ?>" alt=""
                                                    class="img-fluid">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image rounded">
                                                <img src="<?php echo e(asset('assets/images/avatar/4.png')); ?>" alt=""
                                                    class="img-fluid">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image rounded">
                                                <img src="<?php echo e(asset('assets/images/avatar/5.png')); ?>" alt=""
                                                    class="img-fluid">
                                ...
                                <div class="file-result px-4 py-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="<?php echo e(asset('assets/images/file-icons/css.png')); ?>"
                                                    alt="" class="img-fluid">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="<?php echo e(asset('assets/images/file-icons/zip.png')); ?>"
                                                    alt="" class="img-fluid">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="<?php echo e(asset('assets/images/file-icons/pdf.png')); ?>"
                                                    alt="" class="img-fluid">
                    ...
                    <div class="dropdown nxl-h-item">
                        <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button"
                            data-bs-auto-close="outside">
                            <img src="<?php echo e(auth('student')->user()?->admission?->photo
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="text-dark mb-0"><?php echo e(auth('student')->user()?->name); ?></h6>
                                        <span
                                            class="fs-12 fw-medium text-muted"><?php echo e(auth('student')->user()?->email); ?></span>
                                    </div>
                                </div>
                            </div>
                            <a href="<?php echo e(route('student.viewstudent')); ?>" class="dropdown-item">
    ...
    <!--! [Start] Main Content !-->
    <!--! ================================================================ !-->
<?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/layouts/partials/student/dashboard.blade.php ENDPATH**/ ?>