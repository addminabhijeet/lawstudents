...
<style>
    /* ===== GLOBAL ACCESSIBILITY & RESPONSIVE IMPROVEMENTS ===== */

    /* Focus indicators for keyboard navigation (WCAG 2.1 requirement) */
    button:focus,
    a:focus,
    input:focus,
    select:focus,
    ...
    /* Button responsive sizing - 44px+ touch target on mobile */
    .btn {
        min-height: 44px;
        padding: 12px 24px;
            ...
            <div class="courses-notes-grid" data-aos="fade-up">
                ...
                <div class="course-note-card note-plain-card">
                    <div class="course-note-card-body">
                        ...
                        <p>
                            <i class="fa-solid fa-file-pdf" style="color:#d4af37; margin-right:6px;"></i>
