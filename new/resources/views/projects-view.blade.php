...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Law Students || Projects View</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
...
<body>
                                    ...
                                    <div class="card-body task-header d-md-flex align-items-center justify-content-between">
                                        <div class="me-4">
                                            <h4 class="mb-4 fw-bold d-flex">
                                                <span class="text-truncate-1-line">Law Students || CRM Applications &amp; Admin Dashboar <span class="badge bg-soft-primary text-primary mx-3">In Prograss</span></span>
                                            </h4>
                                            <div class="d-flex align-items-center">
                                                <div class="dropdown">
    ...
    <script src="assets/js/projects-view-init.min.js"></script>
    <!--! END: Apps Init !-->
    <!--! BEGIN: Theme Customizer  !-->
