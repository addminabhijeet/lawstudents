                            ...
                            <nav class="side-mobile-menu">
                                ...
                                <ul id="mobile-menu-active">
                                    <li class="dropdown"><a href="index">Home</a>
                                        <ul class="sub-menu">
                                            <li><a href="index">Home Chatbot</a></li>
                                            <li><a href="home-2">Home CRM</a></li>
                                            <li class="active"><a href="#">Home Copy Writing</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a class="scrollspy-btn" href="contact1">Get in touch</a></li>
                                </ul>
                            </nav>
                        </aside>
    ...
    <div class="mobile-nav">
        ...
        <ul class="mobile-nav-list">
            ...
            <li><a href="#">Blogs</a>
                <ul class="sub-menu">
                    <li><a href="blog1">Blog One</a></li>
                    <li><a href="blog-left">Blog Details Left</a></li>
                    <li><a href="blog-right">Blog Details Right</a></li>
                    <li><a href="blog-single">Blog Single</a></li>
                </ul>
            </li>
            <li><a href="contact1">Contact</a></li>
        ...
        <div class="allmobilesection">
            <a href="contact1" class="welconme-btn2">Get Started <span><i class="fa-regular fa-angle-left"></i></span></a>
