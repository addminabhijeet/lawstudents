        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Add Govt. Examination</li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card stretch stretch-full">
                        <div class="card-body">
                            <form action="{{ route('admin.storegovtexams') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <button class="btn btn-primary">Add Govt. Examination</button>
                            </form>
