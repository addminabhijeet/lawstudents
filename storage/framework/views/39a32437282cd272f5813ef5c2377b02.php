                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $categories->whereNotNull('parent_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                    ...
                                    <nav>
                                        <ul class="pagination pagination-sm mb-0">
                                            ...
                                            <li class="page-item <?php echo e($categories->onFirstPage() ? 'disabled' : ''); ?>">
                                                <a class="page-link" href="<?php echo e($categories->previousPageUrl()); ?>" aria-label="Previous">
                                            ...
                                            <li class="page-item <?php echo e(!$categories->hasMorePages() ? 'disabled' : ''); ?>">
                                                <a class="page-link" href="<?php echo e($categories->nextPageUrl()); ?>" aria-label="Next">
            ...
            <div class="modal-body">
                <div class="notes-box">
                    <div class="notes-content">
                        <form action="<?php echo e(route('admin.storecourse')); ?>" method="POST"
...
</script><?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/course/listsubcategory.blade.php ENDPATH**/ ?>