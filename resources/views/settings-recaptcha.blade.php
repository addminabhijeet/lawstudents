...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Law Students || reCAPTCHA Settings</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <div class="mb-5">
                                    ...
                                    <small class="form-text text-muted">Google API Client ID [Ex: G-theme_ocean-2023]</small>
                                </div>
                                <div class="mb-5">
                                ...
                                <div class="mb-5">
                                    ...
                                    <small class="form-text text-muted">Site key [Ex: G-theme_ocean-2023]</small>
                                </div>
                                <div class="mb-5">
