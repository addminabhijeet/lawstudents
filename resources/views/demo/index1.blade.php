@extends('layouts.base', ['title' => 'Lawsy || Criminal Law || 02', 'logo8' => true])

@section('content')
  @include('layouts.partials.loader', ['loader' => 'preloader2'])
  ...
  <div class="welcome4-section-area">
    ...
    <div class="row">
      ...
      <div class="welcome4-header">
        ...
        <a href="{{ route('second', ['contact', 'v1']) }}" class="welcome-btn4">Request Case Evolution <i class="fa-regular fa-arrow-right"></i></a>
        <a href="{{ route('second', ['contact', 'v2']) }}" class="welcome-btn5">Learn More <i class="fa-regular fa-arrow-right"></i></a>
        </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="about4-all-boxarea">
        ...
        <div class="about4-single-content-area">
          <a href="{{ route('second', ['service', 'single']) }}">Legal Expertise</a>
        ...
        <div class="about4-single-content-area">
          <a href="{{ route('second', ['service', 'single']) }}">Protection & Rights</a>
          <p>Criminal defense lawyers have specialized knowledge and expertise in criminal law, courtroom procedures.</p>
        </div>
        </div>
        ...
        <div class="about4-single-content-area">
          <a href="{{ route('second', ['service', 'single']) }}">Courtroom Representation</a>
          <p>Criminal defense lawyers have specialized knowledge and expertise in criminal law, courtroom procedures.</p>
        </div>
        </div>
      </div>
      ...
      <div class="about4-textarea">
        ...
        <a href="{{ route('second', ['pages', 'about']) }}" class="welcome-btn4">Request Case Evolution <i class="fa-regular fa-arrow-right"></i></a>
        </div>
      </div>
      </div>
    </div>
    ...
    <div class="col-lg-12" data-aos="fade-down" data-aos-duration="1000">
      ...
      <div class="service4-boxarea">
        ...
        <div class="service4-author-area">
          ...
          <a href="{{ route('second', ['service', 'single']) }}">Property Crimes</a>
          </div>
        </div>
      ...
      <div class="service4-boxarea">
        ...
        <div class="service4-author-area">
          ...
          <div class="service4-main-heading">
          <a href="{{ route('second', ['service', 'single']) }}">Drug Violence</a>
          </div>
        </div>
        <div class="service4-content2-area">
          <p>Our mission at defend right landing to pages is to provide comprehensive and reliable digital solutions for criminal.</p>
      ...
      <div class="testimonial-sliders">
        ...
        <div class="col-lg-8">
          ...
          <div class="testimonial3-slider-content-area">
            ...
            <div class="man3-text">
              <a href="{{ route('second', ['pages', 'team2']) }}">Ben Stokes</a>
              <p>Owner Taxfirm</p>
            </div>
            </div>
          </div>
  ...
  <div class="blog4-section-area sp3">
    ...
    <div class="row">
      ...
      <div class="blog4-boxarea">
        ...
        <a href="{{ route('second', ['blog', 'single']) }}">Stay Informed About Criminal Law Updates</a>
        <p>Our team of dedicated criminal defense attorneys is here to has provide unwavering support and expert legal guidance lawyer.</p>
        <a href="{{ route('second', ['blog', 'single']) }}" class="readmore">Read More <i class="fa-regular fa-arrow-right"></i></a>
        </div>
      </div>
  ...
  <div class="cta4-scetion-area sp4">
    ...
    <div class="row">
      ...
      <div class="cta3-header text-center">
        ...
        <div data-aos="fade-up" data-aos-duration="1200">
        <a href="{{ route('second', ['contact', 'v1']) }}" class="cta3-btn1">Free Case Evaluation <i class="fa-regular fa-arrow-right"></i></a>
        <a href="{{ route('second', ['contact', 'v2']) }}" class="cta3-btn2">Contact Us <i class="fa-regular fa-arrow-right"></i></a>
        </div>
      </div>
      </div>
    </div>
