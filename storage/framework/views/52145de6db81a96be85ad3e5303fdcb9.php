        ...
        <div class="col-lg-8">
          <div class="welcome3-header-area text-center">
            ...
            <div data-aos="fade-up" data-aos-duration="1200">
              <a href="<?php echo e(route('second', ['contact', 'v1'])); ?>" class="casebtn1">Request Case Evolution <span><i class="fa-regular fa-arrow-right"></i></span></a>
              <a href="<?php echo e(route('second', ['contact', 'v2'])); ?>" class="casebtn2">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
            </div>
          </div>
        </div>
        <div class="col-lg-2">
          ...
          <div class="others-content-area text-center">
            <div class="others-img1" data-aos="fade-up" data-aos-duration="600">
              ...
              <div class="others-arrow">
                <a href="<?php echo e(route('second', ['service', 'single'])); ?>"><i class="fa-regular fa-angles-right"></i></a>
              </div>
            </div>
        ...
        <div class="col-lg-6">
          <div class="about3-textarea">
            ...
            <div class="div" data-aos="fade-right" data-aos-duration="800" data-aos-easing="linear">
              <a href="<?php echo e(route('second', ['pages', 'about'])); ?>" class="casebtn1">Request Case Evolution <span><i class="fa-regular fa-arrow-right"></i></span></a>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
              ...
              <div class="col-lg-6">
                <div class="slider-nav1">
                  <div class="testimonial-listarea">
                    ...
                    <div class="div">
                      <a href="<?php echo e(route('second', ['service', 'single'])); ?>" class="casebtn1">Read More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                    </div>
                  </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6" data-aos="fade-right" data-aos-duration="1000">
          <div class="blog3-boxarea">
            ...
            <div class="blog3-content-area">
              ...
              <a href="<?php echo e(route('second', ['blog', 'single'])); ?>" class="learnmore">Learn More <i class="fa-regular fa-arrow-right"></i></a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-12" data-aos="fade-up" data-aos-duration="1200">
          <div class="div text-center">
            <a href="<?php echo e(route('second', ['blog', 'single'])); ?>" class="casebtn1">See More Articles <span><i class="fa-regular fa-arrow-right"></i></span></a>
          </div>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('layouts.landing' , ['title' => 'Lawsy || Criminal Law || 01'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Lawsy\resources\views/index.blade.php ENDPATH**/ ?>