<!--===== RESPONSIVE HEADER STYLES (MODERN MOBILE REDESIGN) =======-->
<style>
    ...
    .main-menu-ex.homepage6 ul li a::after {
        content: '';
        position: absolute;
        bottom: 0;
        left: 50%;
    ...
    .main-menu-ex.homepage6 ul li a:hover::after {
        width: 80%;
    }
                                ...
                                <ul style="display: flex; flex-wrap: nowrap; align-items: center; gap: 0px; margin: 0; padding: 0; list-style: none;">
                                    ...
                                    <li style="list-style: none; flex-shrink: 0;">
                                        <a href="{{ route('login') }}" class="btn"
                                            style="background-color:#d4af37; color:#0f0f0f; border-color:#d4af37; white-space: nowrap;">
                                            Login / Register
                                        </a>
                                    </li>
                                </ul>
