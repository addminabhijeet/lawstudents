        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Edit Free Notes</li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card stretch stretch-full">
                        <div class="card-body">
                            <form action="<?php echo e(route('admin.updatecopys', $copys->id)); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="category_id" id="category_id" class="form-select" required>
                                        ...
                                        <option value="<?php echo e($category->id); ?>"
                                            <?php echo e(old('category_id', $copys->category_id) == $category->id ? 'selected' : ''); ?>>
                                ...
                                <!-- Existing PDFs -->
                                <?php if(!empty($copys->pdfs)): ?>
                                <div class="mb-3">
                                    <label class="form-label">Existing PDFs</label>
                                    <ul class="list-group">
                                        <?php $__currentLoopData = $copys->pdfs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pdf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" class="form-control"><?php echo e(old('description', $copys->description)); ?></textarea>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const oldCat = "<?php echo e(old('category_id', $copys->category_id)); ?>";
        const oldSub = "<?php echo e(old('subcategory_id', $copys->subcategory_id)); ?>";
...
<?php echo $__env->make('layouts.partials.admin.theme', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/copys/edit.blade.php ENDPATH**/ ?>