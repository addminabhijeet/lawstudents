        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Edit Govt. Examination</li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card stretch stretch-full">
                        <div class="card-body">
                            <form action="{{ route('admin.updategovtexams', $exams->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="category_id" id="category_id" class="form-select" required>
                                        ...
                                        <option value="{{ $category->id }}"
                                            {{ old('category_id', $exams->category_id) == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" class="form-control">{{ old('description', $exams->description) }}</textarea>
                                </div>

                                <button class="btn btn-primary">Update Govt. Examination</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const oldCat = "{{ old('category_id', $exams->category_id) }}";
        const oldSub = "{{ old('subcategory_id', $exams->subcategory_id) }}";
