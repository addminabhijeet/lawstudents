            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        <a href="<?php echo e(route('admin.addrulescategory')); ?>" class="btn btn-primary">
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover" id="rulesCategoriesList">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    <a href="<?php echo e(route('admin.editrulescategory', $categorie->id)); ?>" class="btn btn-sm btn-primary">Edit</a>

                                                    <form action="<?php echo e(route('admin.deleterulescategoryfile', $categorie->id)); ?>" method="POST" class="d-inline">
                                                        <?php echo csrf_field(); ?>
                                ...
                                <div class="d-flex justify-content-center mt-3">
                                    <nav>
                                        <ul class="pagination pagination-sm mb-0">
                                            ...
                                            <li
                                                class="page-item <?php echo e($categories->currentPage() == $page ? 'active' : ''); ?>">
                                                <a class="page-link"
...
<?php echo $__env->make('layouts.partials.admin.theme', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/rules/categories/list.blade.php ENDPATH**/ ?>