@extends('layouts.landing' , ['title' => 'Law Students || Criminal Law || Practice Left'])
      ...
      <div class="row">
        <div class="col-lg-5 m-auto">
          <div class="welcome-inner-header text-center">
            ...
            <a href="{{ route('any', 'index') }}">Home <span><i class="fa-light fa-angle-right"></i></span> Assault and Battery</a>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="800" data-aos-easing="linear">
          <div class="service2-author-box">
            ...
            <div class="tax-content">
              <a href="{{ route('second', ['service', 'right']) }}">White-Collar Crimes</a>
              <p>Law strategy, or a legal professional in to the search of the latest updates and insights.</p>
            </div>
            <a href="{{ route('second', ['service', 'single']) }}" class="learn-more">Read More<i class="fa-regular fa-arrow-right"></i></a>
            <div class="arrow-service">
