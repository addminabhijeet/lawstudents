...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Law Students || Dashboard</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                                        ...
                                        <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                            <div class="row g-4 align-items-center">
                                                ...
                                                <div class="col-xl-4">
                                                    ...
                                                    <div class="mt-4">
                                                        <a href="mailto:flexilecode@gmail.com" class="fs-13 fw-bold">View all resources on Law Students &rarr;</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="tab-pane fade" id="v-pills-features" role="tabpanel">
                                                    <div class="row g-4 nxl-mega-menu-miscellaneous-features">
                                                        ...
                                                        <div class="col-xxl-3 offset-xxl-1 col-xl-4">
                                                            ...
                                                            <div class="mt-4">
                                                                <a href="mailto:flexilecode@gmail.com" class="fs-13 fw-bold">View all features on Law Students &rarr;</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
