            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        <a href="<?php echo e(route('admin.addrulessubcategory')); ?>" class="btn btn-primary">
                                ...
                                <table class="table table-hover" id="rulesList">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($subcategorie->category ? $subcategorie->category->name : 'N/A'); ?></td>
                                            <td><?php echo e($subcategorie->created_at->format('Y-m-d, h:i A')); ?></td>
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    <a href="<?php echo e(route('admin.editrulessubcategory', $subcategorie->id)); ?>" class="btn btn-sm btn-primary">Edit</a>

                                                    <form method="POST" action="<?php echo e(route('admin.deleterulessubcategoryfile', $subcategorie->id)); ?>" class="d-inline">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.partials.admin.theme', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/rules/subcategories/list.blade.php ENDPATH**/ ?>