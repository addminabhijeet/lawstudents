            ...
            <div class="col-lg-6 m-auto">
                <div class="cta3-header text-center">
                    ...
                    <div class="div" data-aos="fade-up" data-aos-duration="1200">
                        <a href="<?php echo e(route('second', ['contact', 'v1'])); ?>" class="cta3-btn1">Request Case Evolution</a>
                        <a href="<?php echo e(route('second', ['contact', 'v2'])); ?>" class="cta3-btn2">Contact Us</a>
                    </div>
                </div>
            </div>
        </div>
...
<!--===== CTA ENDS =======--><?php /**PATH C:\xampp\htdocs\Lawsy\resources\views/layouts/partials/cta.blade.php ENDPATH**/ ?>