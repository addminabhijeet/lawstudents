      ...
      <div class="row">
        <div class="col-12">
          <div class="header-elements">
            <div class="site-logo">
              <a href="{{ route('any', 'index') }}"><img src="/img/logo/logo5.png" alt=""></a>
            </div>
            ...
            <aside class="slide-bar slide-bar3">
              ...
              <nav class="side-mobile-menu">
                ...
                <ul id="mobile-menu-active">
                  ...
                  <li><a class="scrollspy-btn" href="{{ route('second', ['contact', 'v1']) }}">Get in touch</a></li>
                </ul>
              </nav>
            </aside>
...
<div class="mobile-sidebar sidebar3">
  ...
  <div class="mobile-nav">
    ...
    <div class="allmobilesection">
      <a href="{{ route('second', ['contact', 'v1']) }}" class="casebtn1">Get Started</a>
