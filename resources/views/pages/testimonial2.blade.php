    ...
    <div class="row">
      ...
      <div class="testimonial-boxarea">
        ...
        <div class="testimonial-images-area">
          ...
          <div class="testimonial-content">
          <a href="{{ route('second', ['pages', 'team1']) }}">Alex Carey</a>
      ...
      <div class="testimonial-boxarea">
        ...
        <div class="testimonial-images-area">
          ...
          <div class="testimonial-content">
          <a href="{{ route('second', ['pages', 'team1']) }}">Sherman Crist</a>
      ...
      <div class="testimonial-boxarea">
        ...
        <div class="testimonial-images-area">
          ...
          <div class="testimonial-content">
          <a href="{{ route('second', ['pages', 'team1']) }}">Emily Schinner</a>
      ...
      <div class="testimonial-boxarea">
        ...
        <div class="testimonial-images-area">
          ...
          <div class="testimonial-content">
          <a href="{{ route('second', ['pages', 'team1']) }}">Alison Willms</a>
      ...
      <div class="testimonial-boxarea">
        ...
        <div class="testimonial-images-area">
          ...
          <div class="testimonial-content">
          <a href="{{ route('second', ['pages', 'team1']) }}">Kenneth Beier</a>
