        ...
        <div class="page-header">
            ...
            <div class="page-header-right ms-auto">
                <div class="d-flex align-items-center gap-2">
                    <a href="<?php echo e(route('admin.addcopyscategory')); ?>" class="btn btn-primary">
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <!-- Edit -->
                                                        <a href="<?php echo e(route('admin.editcopyscategory', [$categorie->id])); ?>"
                                                        ...
                                                        <!-- Delete -->
                                                        <form action="<?php echo e(route('admin.deletecopyscategoryfile', [$categorie->id])); ?>"
...
<?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/copys/categories/list.blade.php ENDPATH**/ ?>