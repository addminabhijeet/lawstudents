            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        <a href="<?php echo e(route('admin.addcopyssubcategory')); ?>" class="btn btn-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    <a href="<?php echo e(route('admin.editcopyssubcategory', $subcategorie->id)); ?>" class="btn btn-sm btn-primary">Edit</a>

                                                    <form method="POST" action="<?php echo e(route('admin.deletecopyssubcategoryfile', $subcategorie->id)); ?>" class="d-inline">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.partials.admin.theme', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/copys/subcategories/list.blade.php ENDPATH**/ ?>