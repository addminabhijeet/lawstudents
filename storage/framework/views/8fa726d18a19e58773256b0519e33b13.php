                ...
                <table class="container" style="border-top:4px solid #FA0F00;">
                        ...
                        <td class="content" style="padding-top:0;">
                            <table width="100%" cellpadding="14">
                                ...
                                <tr class="row-alt">
                                    ...
                                    <td class="value">
                                        <?php echo e(isset($lines[0]) ? str_replace('Name: ', '', $lines[0]) : ''); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="value">
                                        <?php echo e(isset($lines[1]) ? str_replace('Phone: ', '', $lines[1]) : ''); ?>
                                ...
                                <tr class="row-alt">
                                    ...
                                    <td class="value">
                                        <?php echo e(isset($lines[2]) ? str_replace('Email: ', '', $lines[2]) : ''); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="value">
                                        <?php echo e(isset($lines[3]) ? str_replace('Service: ', '', $lines[3]) : ''); ?>
                                ...
                                <tr class="row-alt">
                                    ...
                                    <td class="value">
                                        <?php echo e(isset($lines[4]) ? str_replace('Message: ', '', $lines[4]) : ''); ?>
                    ...
                    <tr>
                        <td align="center" style="padding-bottom:40px;">
                            <a href="mailto:<?php echo e(isset($lines[2]) ? str_replace('Email: ', '', $lines[2]) : ''); ?>"
                                class="btn"
...
</html><?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/emails/contact-mail.blade.php ENDPATH**/ ?>