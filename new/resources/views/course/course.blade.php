...
@section('content')
<!-- ===== MODERN MOBILE REDESIGN FOR COURSE PAGE ======= -->
<style>
    ...
    * {
    ...
    /* ===== HEADING STYLES FOR COURSE PAGE (MODERN) ===== */
        ...
        <div class="row">
            <div class="col-lg-3 m-auto">
                <div class="welcome-inner-header text-center">
                    <h1>Courses</h1>
                    <a href="{{ route('frontend.home') }}">Home <span><i class="fa-light fa-angle-right"></i></span>Courses</a>
