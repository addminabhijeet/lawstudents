...
<main class="nxl-container">
    <div class="nxl-content">
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Add Student Admission</li>
                </ul>
            </div>
        ...
        <form action="<?php echo e(route('admin.registeradmsubmit')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="admno"
                                        value="<?php echo e($admno); ?>" readonly>
                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check mb-2 p-2 border rounded">
                                                        <input class="form-check-input course-checkbox" type="checkbox"
                                                            name="course_ids[]" value="<?php echo e($course->id); ?>"
...
<?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/admission/add.blade.php ENDPATH**/ ?>