        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Add Legal Knowledge</li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card stretch stretch-full">
                        <div class="card-body">
                            <form action="{{ route('admin.storelegalknowledgelibrary') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <button class="btn btn-primary">Add Legal Knowledge</button>
                            </form>
