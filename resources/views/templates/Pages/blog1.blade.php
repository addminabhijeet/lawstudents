...
<head>
  <?= $this->element('title_meta' , ['title' => 'Lawsy || Criminal Law || Our Blog 01' ]) ?>
        ...
        <div class="col-lg-6 col-md-6">
          <div class="blog3-boxarea">
            ...
            <div class="blog3-content-area">
              ...
              <a href="blog-single" class="learnmore">Learn More <i class="fa-light fa-arrow-right"></i></a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6">
          <div class="blog3-boxarea">
            ...
            <div class="blog3-content-area">
              ...
              <a href="blog-single">Premier Criminal Defense Counsel at Your Service</a>
              <p>Our team of dedicated criminal defense attorneys is here to has provide unwavering support and expert legal guidance lawyer.</p>
              <a href="blog-single" class="learnmore">Learn More <i class="fa-light fa-arrow-right"></i></a>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-md-6">
          <div class="blog3-boxarea">
            ...
            <div class="blog3-content-area">
              ...
              <a href="blog-single">Expert Criminal Defense Attorneys by Your Side</a>
              <p>Our team of dedicated criminal defense attorneys is here to has provide unwavering support and expert legal guidance lawyer.</p>
              <a href="blog-single" class="learnmore">Learn More <i class="fa-light fa-arrow-right"></i></a>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-md-6">
          <div class="blog3-boxarea">
            ...
            <div class="blog3-content-area">
              ...
              <a href="blog-single">Trustworthy Criminal Lawyers Protecting Rights</a>
              <p>Our team of dedicated criminal defense attorneys is here to has provide unwavering support and expert legal guidance lawyer.</p>
              <a href="blog-single" class="learnmore">Learn More <i class="fa-light fa-arrow-right"></i></a>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-md-6">
          <div class="blog3-boxarea">
            ...
            <div class="blog3-content-area">
              ...
              <a href="blog-single">Criminal Defense Lawyers Ready to Fight for You</a>
              <p>Our team of dedicated criminal defense attorneys is here to has provide unwavering support and expert legal guidance lawyer.</p>
              <a href="blog-single" class="learnmore">Learn More <i class="fa-light fa-arrow-right"></i></a>
            </div>
          </div>
