...
class SitePageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $pages = [
            [
                ...
                'content' => $this->getPrivacyPolicyContent($docEmail, $docMobile),
            ],
            [
                'slug' => 'terms-and-conditions',
                'title' => 'Terms & Conditions',
                'content' => $this->getTermsContent($docEmail),
            ],
            [
                'slug' => 'disclaimer',
                'title' => 'Disclaimer',
            ...
            [
                'slug' => 'refund-policy',
                'title' => 'Refund Policy',
                'content' => $this->getRefundPolicyContent($docEmail, $docMobile),
            ],
        ];
    ...
    private function getPrivacyPolicyContent($email, $mobile)
    {
        return <<<HTML
...
<p>Email <a href="mailto:$email">$email</a> or call <a href="tel:$mobile">$mobile</a>. Address: 224 Legal District, Delhi High Court Marg, New Delhi 110001.</p>
HTML;
    }

    private function getTermsContent($email)
    {
        return <<<HTML
...
HTML;
    ...
    private function getRefundPolicyContent($email, $mobile)
    {
        return <<<HTML
...
<p>Email <a href="mailto:$email">$email</a> or call <a href="tel:$mobile">$mobile</a> with your name, registered phone number, course name and payment reference.</p>
