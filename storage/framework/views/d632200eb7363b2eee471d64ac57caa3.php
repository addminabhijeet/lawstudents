    ...
    <div class="container">
        <div class="row">
            ...
            <div style="width:100%; max-width:1100px; margin:auto;">
                            ...
                            <div style="position:relative;">
                                ...
                                <div id="categoryDropdownMenu"
                                    ...
                                    <div style="max-height:380px; overflow-y:auto;">
                                        ...
                                        <!-- Parent Category -->
                                        <div class="dropdown-parent-rule" data-category-id="<?php echo e($category->id); ?>"
                                            style="padding:14px 16px; cursor:pointer; border-bottom:1px solid #f3f4f6;
                                                    display:flex; justify-content:space-between; align-items:center;
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <!-- CATEGORY -->
                <div class="rule-category" data-category-id="<?php echo e($category->id); ?>" style="margin-bottom:15px; border:1px solid #ddd; border-radius:10px; overflow:hidden;">

                    <div onclick="toggleAccordion('cat<?php echo e($category->id); ?>')"
                    ...
                    <!-- 🔥 OPEN BY DEFAULT -->
                    <div id="cat<?php echo e($category->id); ?>" class="accordion-content" style="max-height:1000px;">
                        ...
                        <div style="margin:10px; border:1px dashed #ccc; border-radius:6px; overflow:hidden;">
                            ...
                            <div onclick="toggleAccordion('sub<?php echo e($sub->id); ?>')"
                            ...
                            <!-- 🔥 OPEN BY DEFAULT -->
                            <div id="sub<?php echo e($sub->id); ?>" class="accordion-content" style="padding:10px; max-height:1000px;">

                                <?php $__currentLoopData = $sub->rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <!-- RULE -->
                                <div data-rule-id="<?php echo e($rule->id); ?>" style="margin-bottom:10px; padding:10px; border:1px solid #eee; border-radius:6px;">
                                    ...
                                    <!-- PDFs -->
                                    <?php if($rule->pdfs): ?>
                                    <?php $__currentLoopData = $rule->pdfs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pdf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div style="margin-top:5px; display:flex; justify-content:space-between; align-items:center;">
                                        <span style="font-size:12px;">PDF <?php echo e($index + 1); ?></span>
                                        <div>
                                            <!-- VIEW button -->
                                            <a href="<?php echo e(asset('storage/app/public/' . $pdf)); ?>" target="_blank" style="margin-right:10px; font-size:12px;">
                                                View
                                            </a>

                                            <!-- DOWNLOAD button -->
                                            <?php if(auth()->check()): ?>
                                            <a href="<?php echo e(asset('storage/app/public/' . $pdf)); ?>" download style="font-size:12px; color:green;">
                                                Download
                                            </a>
                                            <?php else: ?>
                                            <a href="<?php echo e(route('google.login')); ?>" style="font-size:12px; color:green;">
                                                Download
                                            </a>
                                            <?php endif; ?>
                                        </div>
            ...
            <script>
                ...
                function searchNotes(query) {
                    ...
                    fetch(`<?php echo e(route('frontend.rulessearch')); ?>?q=${encodeURIComponent(query)}`)
                        .then(res => res.json())
                        .then(data => {
                            if (!data.length) {
...
<?php echo $__env->make('layouts.landing', ['title' => 'Law Students'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/rules/rules.blade.php ENDPATH**/ ?>