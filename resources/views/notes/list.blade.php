    ...
    <div class="content-area" data-scrollbar-target="#psScrollbarInit">
        <div class="content-area-header sticky-top">
            <div class="page-header-left d-flex align-items-center gap-2">
                ...
                <div class="dropdown">
                    <a href="javascript:void(0)" class="btn btn-light-brand dropdown-toggle" data-bs-toggle="dropdown"
                        data-bs-offset="0,18">Project Notes</a>
            ...
            <div class="row note-has-grid" id="note-full-container">
                ...
                <div
                    ...
                    <div class="card card-body mb-4 stretch stretch-full">
                        ...
                        <h5 class="note-title text-truncate w-75 mb-1" data-noteheading="Book a Ticket for Movie">Book
                            a Ticket for Movie <i class="point bi bi-circle-fill ms-1 fs-7"></i></h5>
                        ...
                        <div class="note-content flex-grow-1">
                            <p class="text-muted note-inner-content text-truncate-3-line"
                                ...
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis vitae iure, quo harum
                                excepturi laudantium eum earum accusantium labore libero maiores illo soluta.</p>
                        </div>
                ...
                <!--! BEGIN: [Single Note Item] !-->
                <div
                    class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 single-note-item all-category note-important note-archive note-works">
                    <div class="card card-body mb-4 stretch stretch-full">
                        <span class="side-stick"></span>
                        <h5 class="note-title text-truncate w-75 mb-1" data-noteheading="Go for lunch">Go for lunch <i
                ...
                <!--! BEGIN: [Single Note Item] !-->
                <div
                    class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 single-note-item all-category note-social note-archive note-personal">
                    <div class="card card-body mb-4 stretch stretch-full">
                        <span class="side-stick"></span>
                        <h5 class="note-title text-truncate w-75 mb-1" data-noteheading="Meeting with Mr.Jojo">Meeting
                            with Mr.Jojo <i class="point bi bi-circle-fill ms-1 fs-7"></i></h5>
                ...
                <!--! BEGIN: [Single Note Item] !-->
                <div
                    class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 single-note-item all-category note-business note-tasks">
                    <div class="card card-body mb-4 stretch stretch-full">
                        <span class="side-stick"></span>
                        <h5 class="note-title text-truncate w-75 mb-1" data-noteheading="Give Review for design">Give
                            Review for design <i class="point bi bi-circle-fill ms-1 fs-7"></i></h5>
                ...
                <!--! BEGIN: [Single Note Item] !-->
                <div
                    class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 single-note-item all-category note-social note-archive">
                    <div class="card card-body mb-4 stretch stretch-full">
                        <span class="side-stick"></span>
                        <h5 class="note-title text-truncate w-75 mb-1" data-noteheading="Nightout with friends">
                            Nightout with friends <i class="point bi bi-circle-fill ms-1 fs-7"></i></h5>
                ...
                <!--! BEGIN: [Single Note Item] !-->
                <div
                    class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 single-note-item all-category note-important note-works">
                    <div class="card card-body mb-4 stretch stretch-full">
                        <span class="side-stick"></span>
                        <h5 class="note-title text-truncate w-75 mb-1" data-noteheading="Launch new template">Launch
                            new template <i class="point bi bi-circle-fill ms-1 fs-7"></i></h5>
                ...
                <div
                    ...
                    <div class="card card-body mb-4 stretch stretch-full">
                        <span class="side-stick"></span>
                        <h5 class="note-title text-truncate w-75 mb-1" data-noteheading="Change a Design">Change a
                            Design <i class="point bi bi-circle-fill ms-1 fs-7"></i></h5>
                ...
                <!--! BEGIN: [Single Note Item] !-->
                <div
                    class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 single-note-item all-category note-business note-priority">
                    <div class="card card-body mb-4 stretch stretch-full">
                        <span class="side-stick"></span>
                        <h5 class="note-title text-truncate w-75 mb-1" data-noteheading="Give review for foods">Give
                            review for foods <i class="point bi bi-circle-fill ms-1 fs-7"></i></h5>
                ...
                <div
                    ...
                    <div class="card card-body mb-4 stretch stretch-full">
                        <span class="side-stick"></span>
                        <h5 class="note-title text-truncate w-75 mb-1" data-noteheading="Give salary to employee">Give
                            salary to employee <i class="point bi bi-circle-fill ms-1 fs-7"></i></h5>
                ...
                <!--! BEGIN: [Single Note Item] !-->
                <div
                    class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 single-note-item all-category note-important note-archive">
                    <div class="card card-body mb-4 stretch stretch-full">
                        <span class="side-stick"></span>
                        <h5 class="note-title text-truncate w-75 mb-1" data-noteheading="Go for lunch">Go for lunch <i
                                class="point bi bi-circle-fill ms-1 fs-7"></i></h5>
