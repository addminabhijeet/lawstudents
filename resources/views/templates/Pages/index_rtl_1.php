...
<head>
  <?= $this->element('title_meta' , ['title' => 'Lawsy || Tax Law || 02' , 'logo4' => true ]) ?>

  <?= $this->element("head_css") ?>
</head>

<body class="rtl-homege-area">

  <?= $this->element("loader" , ['loader' => 'preloader4']) ?>

  <?= $this->element("header/navbar_rtl") ?>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="welcome-header2-text">
            <span data-aos="fade-left" data-aos-duration="600">We provide the experience you need</span>
            <h1 data-aos="fade-left" data-aos-duration="800">Trusted Tax <span>Attorneys <img src="/img/elements/quito2.png" alt="" class="d-none"></span> Solve Your Tax Issues</h1>
            <p data-aos="fade-left" data-aos-duration="1000">With a track record of successfully resolving a tax-related issues, we're <br> committed to protecting your financial interests and helping achieve </p>
            <div class="div" data-aos="fade-left" data-aos-duration="1000">
              <a href="contact1" class="welconme-btn2">Download Tax Guides <span><i class="fa-regular fa-angle-left"></i></span></a>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="welcome-header2-images">
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6" data-aos="zoom-out" data-aos-duration="1400">
  ...
  <div class="about-section-area sp1">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-2">
          <div class="div" data-aos="zoom-in" data-aos-duration="800">
          ...
          <div class="space20"></div>
          <div class="div" data-aos="zoom-in" data-aos-duration="1200">
            <div class="about-side-boxarea text-center">
              <div class="side-icon">
        ...
        <div class="col-lg-5">
          <div class="about2-textarea">
            ...
            <h2 class="text-capitalize" data-aos="fade-right" data-aos-duration="800">Protect Your  and <img src="/img/elements/quito2.png" alt="" class="d-lg-block d-none"> Minimize Tax Liability</h2>
            <p data-aos="fade-right" data-aos-duration="1000">Whether you're facing a tax audit, need assistance with tax compliance, or are looking for ways to maximize tax benefits.</p>
            <p data-aos="fade-right" data-aos-duration="1000">Explore our website to learn more about our services and get to know our team of tax attorneys. When you're ready Lawyer.</p>
            <div class="about-list" data-aos="fade-right" data-aos-duration="1200">
              <ul>
                <li> <img src="/img/icons/check-img1.svg" alt="">Range Of Services</li>
                <li> <img src="/img/icons/check-img1.svg" alt="">Online Recourses</li>
              </ul>
              <ul>
                <li> <img src="/img/icons/check-img1.svg" alt="">Professional Expertise</li>
                <li> <img src="/img/icons/check-img1.svg" alt="">Client Success Stories</li>
              </ul>
            </div>
            <div class="div" data-aos="fade-right" data-aos-duration="1400">
              <a href="about" class="welconme-btn2">About Us <span><i class="fa-regular fa-angle-left"></i></span></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-4">
          <div class="service2-header-text">
            ...
            <h2 data-aos="fade-up" data-aos-duration="800">Tax Resolution <img src="/img/elements/quito2.png" alt="" class="d-none"> <br> Starts Here</h2>
            ...
            <div class="div" data-aos="fade-up" data-aos-duration="1200">
              <a href="service1" class="welconme-btn2">View Our Services <span><i class="fa-regular fa-angle-left"></i></span></a>
            </div>
          </div>
        </div>
        <div class="col-lg-8">
              ...
              <div class="col-lg-6 col-md-6" data-aos="zoom-out" data-aos-duration="800">
                <div class="service2-author-box">
                  ...
                  <div class="tax-content">
                    <a href="service-single">Estate Planning & Taxation</a>
                    <p>From understanding the latest tax code <br> change to exploring tax planning strategies.</p>
                  </div>
                  <a href="service-single" class="learn-more">Learn More<i class="fa-light fa-arrow-left"></i></a>
                  <div class="arrow-service">
                    <span><a href="service-single"><img src="/img/icons/arrow_right.svg" alt=""></a></span>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-lg-6 m-auto">
          <div class="work2-header-text text-center">
            ...
            <h2 class="text-capitalize" data-aos="fade-up" data-aos-duration="800">Legal Tax Assistance <img src="/img/elements/quito2.png" alt="" class="d-none"> <br> Tailored to Your Needs</h2>
          </div>
        </div>
      </div>
      <div class="row align-items-center">
        ...
        <div class="col-lg-7 align-items-center">
          <div class="tabs-author-area" data-aos="fade-left" data-aos-duration="1000">
            <div class="tab-content" id="v-pills-tabContent">
              ...
              <div class="tab-pane  show" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                <div class="tabs-author-images1">
                  <img src="/img/images/tabs-img7.png" alt="" class="tabs-img1">
                </div>
              ...
              <div class="tab-pane show" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                <div class="tabs-author-images1">
                  <img src="/img/images/tabs-img9.png" alt="" class="tabs-img1">
                </div>
      ...
      <div class="row">
        <div class="col-lg-6 m-auto">
          <div class="team1-header text-center">
            ...
            <h2 data-aos="fade-up" data-aos-duration="800">Our Expert Tax law Team <img src="/img/elements/quito2.png" alt="" class="d-none"></h2>
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row align-items-center">
        <div class="col-lg-4">
          <div class="testimonial2-header">
            ...
            <h2 data-aos="fade-left" data-aos-duration="800">Some love words <img src="/img/elements/quito2.png" alt="" class="d-none"> <br> from clients</h2>
            <p data-aos="fade-left" data-aos-duration="1000">"I had a complex international tax issue that required immediate attention. </p>
            <div class="div" data-aos="fade-left" data-aos-duration="1200">
              <a href="" class="welconme-btn2">Read More Reviews <span><i class="fa-regular fa-angle-left"></i></span></a>
            </div>
          </div>
        </div>
        <div class="col-lg-8" data-aos="fade-right" data-aos-duration="1000">
          <div class="testimonial-owlcarousel-area2 owl-carousel tes5 ">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto">
          <div class="blog-header text-center">
            ...
            <h2 data-aos="fade-up" data-aos-duration="800">Our Latest Blog Posts <img src="/img/elements/quito.png" alt="" class="d-none"></h2>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-4 col-md-6" data-aos="fade-right" data-aos-duration="800">
          <div class="blog-boxarea">
            ...
            <div class="blog-all-textarea">
              ...
              <a href="blog-single" class="readmore">Read More <i class="fa-light fa-arrow-left"></i></a>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-12" data-aos="fade-up" data-aos-duration="1400">
        <div class="div text-center">
          <a href="blog-single" class="welconme-btn2">Read More Blog & Articles <span><i class="fa-regular fa-angle-left"></i></span></a>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="row align-items-center">
              <div class="col-lg-6">
                <div class="cta2-header">
                  ...
                  <p>At Your Firm Name, our experienced tax attorneys are here to help you <br> navigate the complexities of tax law, save you money, & ensure.</p>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="cta-contact-area">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="space20"></div>
                      <div class="cta-input">
                        <button type="submit" class="cta-btn2">Schedule A Consultation <span><i class="fa-regular fa-angle-left"></i></span></button>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="footer-form-area">
                    <form>
                      ...
                      <div class="footer-btn">
                        <button type="submit">Subscribe <span><i class="fa-regular fa-angle-left"></i></span></button>
                      </div>
                    </form>
                  </div>
                </div>
