                    ...
                    <div class="col-xl-4">
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                <div class="mb-4 d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="avatar-text avatar-sm" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" title="Grand total invoice">
                                        <i class="feather feather-info"></i>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                        ...
                                        <tbody>
                                            <tr class="single-item">
                                                ...
                                                <td class="w-25"><input type="number" name="sub_total"
                                                        id="sub_total"
                                                        value="{{ old('sub_total', $payment->sub_total) }}" readonly>
                                                </td>
                                            </tr>
                                            <tr class="single-item">
                                                ...
                                                <td class="w-25">
                                                    <div class="input-group mb-2 mb-sm-0">
                                                        <input type="number" id="tax" name="tax_percentage"
                                                            value="{{ old('tax_percentage', $payment->tax_percentage) }}">
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td class="bg-gray-100 w-25"><input type="number" name="grand_total"
                                                        id="total_amount"
                                                        value="{{ old('grand_total', $payment->grand_total) }}"
                                                        readonly></td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                <div class="mb-4 d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="avatar-text avatar-sm" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" title="Select payment methord">
                                        <i class="feather feather-info"></i>
                                    </div>
                                </div>
                                <!-- Nav tabs -->
                                <ul class="nav nav-justified gap-1">
                                    <li class="nav-item border border-gray-500">
                                        <a class="nav-link px-2 {{ $payment->payment_method == 'debit' ? 'active' : '' }}"
                                            data-bs-toggle="tab" data-bs-target="#pamymetDebitCardTab">

                                    </li>
                                    <li class="nav-item border border-gray-500">
                                        <a class="nav-link px-2 {{ $payment->payment_method == 'paypal' ? 'active' : '' }}"
                                            data-bs-toggle="tab" data-bs-target="#pamymetPaypalTab">
                                ...
                                <div class="tab-content mt-4">
                                    <div class="tab-pane fade show active" id="pamymetDebitCardTab" role="tabpanel">
                                        <div class="form-group mb-3">
                                            <input type="text" class="form-control input-credit-card"
                                        ...
                                        <div class="d-flex gap-3">
                                            <div class="form-group">
                                                <input type="text" class="form-control input-date-formatting"
                                                    placeholder="MM/YYYY">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control input-Blocks-formatting"
                                                    placeholder="686">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pamymetPaypalTab" role="tabpanel">
                                        ...
                                        <p>
                                            <a href="http://paypal.com" target="_blank" class="btn btn-primary"><i
                                                    class="bi bi-paypal me-2"></i> Log in my Paypal</a>
                                        </p>
                                        <div class="fs-11 text-muted">Note: There are many variations of passages of
                                            Lorem
                                            Ipsum
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                <div class="mb-4 d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="avatar-text avatar-sm" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" title="Calculate your currency, tax & discount">
                                        <i class="feather feather-info"></i>
                                    </div>
                                </div>
                                <div class="form-group mb-4">
                                    <select class="form-control" data-select2-selector="currency">
                                        ...
                                        <option data-currency="ba">BAM - Bosnia-Herzegovina Convertible Mark - KM
                                        </option>
                                ...
                                <div class="form-group mb-4">
                                    <input type="number" name="discount" id="itemDiscount"
                                        value="{{ old('discount', $payment->discount) }}">

                                </div>
                                <div
                                    class="ps-0 mb-3 form-check form-switch form-switch-sm d-flex align-center justify-content-between">
                                    <label class="fw-bold text-dark" for="LateFees">
                                        <span>Late Fees</span>
                                        <span class="fs-11 fw-normal text-muted d-block">Late fees for extra
                                            charge</span>
                                    </label>
                                    <input class="form-check-input" type="checkbox" name="late_fees" value="1"
                                        {{ $payment->late_fees ? 'checked' : '' }}>
                                </div>
                                <div
                                    class="ps-0 mb-3 form-check form-switch form-switch-sm d-flex align-center justify-content-between">
                                    <label class="fw-bold text-dark" for="ClientNote">
                                        <span>Client Notes</span>
                                        <span class="fs-11 fw-normal text-muted d-block">Client notes for further
                                            query</span>
                                    </label>
                                    <input class="form-check-input" type="checkbox" name="client_note_enabled"
                                        value="1" {{ $payment->client_note_enabled ? 'checked' : '' }}>
                                </div>
                                <div
                                    class="ps-0 form-check form-switch form-switch-sm d-flex align-center justify-content-between">
                                    <label class="fw-bold text-dark" for="SavePayment">
                                        <span>Save Payment</span>
                                        <span class="fs-11 fw-normal text-muted d-block">Save payment for quick
                                            payout</span>
                                    </label>
                                    <input class="form-check-input" type="checkbox" name="save_payment"
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                ...
                                <p class="fs-12 text-muted mb-4">Are you sure you want to cancel this invoice? Neigther
                                    you nor
                                    alex will able to make any(more) payments on it.</p>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="notifyMe"
                                        checked="">
                                    <label class="custom-control-label c-pointer" for="notifyMe">Notify alex that this
                                        invoice
                                        was
                                        cancelled.</label>
                                </div>
                                <a href="javascript:void(0);"
                                    class="btn bg-soft-danger text-danger mt-4 successAlertMessage">Cancel this
                                    Invoice</a>
                            </div>
                        </div>
                    </div>
