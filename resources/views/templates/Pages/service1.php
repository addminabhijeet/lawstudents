...
<head>
  <?= $this->element('title_meta' , ['title' => 'Lawsy || Criminal Law || Practice Areas' ]) ?>
      ...
      <div class="row">
        <div class="col-lg-4 m-auto">
          <div class="welcome-inner-header text-center">
            ...
            <a href="index">Home <span><i class="fa-light fa-angle-right"></i></span> Practice Areas</a>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service2-author-box">
            ...
            <div class="tax-content">
              <a href="service-single">Theft and Property Crimes</a>
              <p>Law strategy, or a legal professional in to the search of the latest updates and insights.</p>
            </div>
            <a href="service-single" class="learn-more">Read More<i class="fa-regular fa-arrow-right"></i></a>
            <div class="arrow-service">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service2-author-box">
            ...
            <div class="tax-content">
              <a href="service-single">Juvenile Defense</a>
              <p>Law strategy, or a legal professional in to the search of the latest updates and insights.</p>
            </div>
            <a href="service-single" class="learn-more">Read More<i class="fa-regular fa-arrow-right"></i></a>
            <div class="arrow-service">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service2-author-box">
            ...
            <div class="tax-content">
              <a href="service-single">Federal Crimes</a>
              <p>Law strategy, or a legal professional in to the search of the latest updates and insights.</p>
            </div>
            <a href="service-single" class="learn-more">Read More<i class="fa-regular fa-arrow-right"></i></a>
            <div class="arrow-service">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service2-author-box">
            ...
            <div class="tax-content">
              <a href="service-single">Divorce Law</a>
              <p>Law strategy, or a legal professional in to the search of the latest updates and insights.</p>
            </div>
            <a href="service-single" class="learn-more">Read More<i class="fa-regular fa-arrow-right"></i></a>
            <div class="arrow-service">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service2-author-box">
            ...
            <div class="tax-content">
              <a href="service-single">Drug Offenses</a>
              <p>Law strategy, or a legal professional in to the search of the latest updates and insights.</p>
            </div>
            <a href="service-single" class="learn-more">Read More<i class="fa-regular fa-arrow-right"></i></a>
            <div class="arrow-service">
