      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="welcome-header2-text">
            ...
            <p data-aos="fade-up" data-aos-duration="900">With a track record of successfully resolving a tax-related issues, we're <br> committed to protecting your financial interests and helping achieve </p>
            <div data-aos="fade-up" data-aos-duration="1200">
              <a href="contact1" class="welconme-btn2">Download Tax Guides <span><i class="fa-regular fa-angle-right"></i></span></a>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
        ...
        <div class="col-lg-5">
          <div class="about2-textarea">
            ...
            <div class="div" data-aos="fade-left" data-aos-duration="1200">
              <a href="about" class="welconme-btn2">About Us <span><i class="fa-regular fa-angle-right"></i></span></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-4">
          <div class="service2-header-text">
            ...
            <div class="div" data-aos="fade-up" data-aos-duration="1200">
              <a href="service1" class="welconme-btn2">View Our Services <span><i class="fa-regular fa-angle-right"></i></span></a>
            </div>
          </div>
        </div>
        <div class="col-lg-8">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-duration="500" data-aos-easing="linear">
                <div class="service2-author-box">
                  ...
                  <a href="service-single" class="learn-more">Learn More<i class="fa-regular fa-arrow-right"></i></a>
      ...
      <div class="row align-items-center">
        <div class="col-lg-4">
          <div class="testimonial2-header">
            ...
            <div class="div" data-aos="fade-up" data-aos-duration="1200">
              <a href="testimonial1" class="welconme-btn2">Read More Reviews <span><i class="fa-regular fa-angle-right"></i></span></a>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="col-lg-12" data-aos="fade-up" data-aos-duration="1400">
        <div class="div text-center">
          <a href="blog1" class="welconme-btn2">Read More & Articles <span><i class="fa-regular fa-angle-right"></i></span></a>
        </div>
      </div>
    </div>
  </div>
