            ...
            <div class="content-area" data-scrollbar-target="#psScrollbarInit">
                ...
                <div class="content-area-body pb-0">
                    <div class="row note-has-grid" id="note-full-container">
                        ...
                        single-note-item all-category category-<?php echo e($category->id); ?>">
                            ...
                            <div class="card card-body mb-4 stretch stretch-full">
                                ...
                                <p class="fs-11 text-muted note-date">
                                    <?php echo e($note->created_at->format('d F Y')); ?>
                                ...
                                <div class="mt-3 d-flex flex-column gap-2">
                                    <a href="javascript:void(0);"
                                        ...
                                        data-id="<?php echo e($note->id); ?>" data-title="<?php echo e($note->title); ?>"
                                        data-description="<?php echo e($note->description); ?>"
                                        data-pdf="<?php echo e(route('admin.viewnote', $note->id)); ?>">
                                    ...
                                    <a href="javascript:void(0);"
                                        ...
                                        data-id="<?php echo e($note->id); ?>" data-title="<?php echo e($note->title); ?>"
                                        data-description="<?php echo e($note->description); ?>"
                                        data-version="<?php echo e($note->version); ?>"
                                        data-course="<?php echo e($note->course_id); ?>"
                                        data-visibility="<?php echo e($note->visibility); ?>"
                                        data-download="<?php echo e($note->is_downloadable); ?>">
                                        <i class="feather-edit me-2"></i>
                                        <span>Edit Note</span>
                                    </a>

                                    <form action="<?php echo e(route('admin.deletenotes', $note->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<div class="modal fade" id="addnotesmodal" tabindex="-1" aria-labelledby="addNotesModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.storenotes')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<script>
    let updateNoteUrl = "<?php echo e(url('admin/course-notes')); ?>";
</script>
<script>
    function removeNote() {
        $(".remove-note")
...
</script><?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/notes/list.blade.php ENDPATH**/ ?>