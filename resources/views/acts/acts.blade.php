                    ...
                    <div id="actCat{{ $category->id }}" class="accordion-content" style="max-height:1000px;">
                        ...
                        <div style="margin:10px; border:1px dashed #ccc; border-radius:6px; overflow:hidden;">
                            ...
                            <div id="actSub{{ $sub->id }}" class="accordion-content" style="padding:10px; max-height:1000px;">
                                ...
                                <!-- ACT -->
                                <div data-act-id="{{ $act->id }}" style="margin-bottom:15px; padding:18px 20px; border:2px solid #ffe8dd; border-left:4px solid #ff5722; border-radius:8px; background:linear-gradient(135deg, #fff9f5 0%, #ffffff 100%); box-shadow: 0 2px 8px rgba(255,87,34,0.08); transition: all 0.3s ease;">
                                    <div style="display:flex; align-items:flex-start; gap:12px;">
                                        ...
                                        <div style="flex:1;">
                                            ...
                                            <div style="margin-top:8px; display:flex; justify-content:space-between; align-items:center; padding:8px 0; border-top:1px solid #f0f0f0;">
                                                ...
                                                <div>
                                                    <a href="{{ asset('storage/app/public/' . $pdf) }}" target="_blank" style="font-size:12px; color:#ff5722; font-weight:600; text-decoration:none; margin-right:12px; transition: all 0.3s ease;">View</a>

                                                    @if (auth()->check())
                                                    <a href="{{ asset('storage/app/public/' . $pdf) }}" download style="font-size:12px; color:#ff5722; font-weight:600; text-decoration:none; transition: all 0.3s ease;">Download</a>
                                                    @else
                                                    <a href="{{ route('google.login') }}" style="font-size:12px; color:#ff5722; font-weight:600; text-decoration:none; transition: all 0.3s ease;">Download</a>
                                                    @endif
                                                </div>
                                            </div>
                                            @endforeach
