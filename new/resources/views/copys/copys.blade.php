...
<!-- ===== MODERN MOBILE REDESIGN FOR FREE NOTES PAGE ======= -->
<style>
    ...
    * {
    ...
    /* ===== MODERN CARD STYLES ===== */
    .accordion-item, .card, [class*="box"], .copy-category {
    ...
    .accordion-item:hover, .card:hover, .copy-category:hover {
    ...
    /* ===== HEADING STYLES FOR FREE NOTES PAGE (MODERN) ===== */
        ...
        <div class="row">
            <div class="col-lg-3 m-auto">
                <div class="welcome-inner-header text-center">
                    <h1>Free Notes</h1>
                    <a href="{{ route('frontend.home') }}">Home <span><i class="fa-light fa-angle-right"></i></span> Free Notes</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div style="width:100%; max-width:1100px; margin:auto;">
                ...
                @foreach ($categories as $category)
                <!-- CATEGORY -->
                <div class="copy-category" data-category-id="{{ $category->id }}" style="margin-bottom:15px; border:1px solid #ddd; border-radius:10px; overflow:hidden;">
