@extends('layouts.landing', ['title' => 'Law Students || Criminal Law || Our Blog 03'])
...
@section('content')
  ...
  <div class="blog5-section-area sp3">
    ...
    <div class="row">
      ...
      <div class="blog5-boxarea">
        <div class="blog5-imgeas">
        <img src="/img/images/blog3-inner-img4.png" alt="">
        </div>
        <div class="blog5-content-area">
        <div class="tags-area">
          <a href="#">#Criminal Lawyer</a>
        </div>
        <a href="{{ route('second', ['blog', 'single']) }}">Premier Criminal Defense Law Attorneys On Your Team</a>
        <p>Child custody is a central concern in many to divorces, We'll explore the different Lawyers.</p>
        <a href="{{ route('second', ['blog', 'single']) }}" class="readmore">Read More <i class="fa-light fa-arrow-right"></i></a>
        </div>
      </div>
      ...
      <div class="blog5-boxarea">
        <div class="blog5-imgeas">
        <img src="/img/images/blog3-inner-img5.png" alt="">
        </div>
        <div class="blog5-content-area">
        <div class="tags-area">
          <a href="#">#Lawer Trusted</a>
        </div>
        <a href="{{ route('second', ['blog', 'single']) }}">Proven Criminal Defense Law Lawyers at Your Beck and Call</a>
        <p>Child custody is a central concern in many to divorces, We'll explore the different Lawyers.</p>
        <a href="{{ route('second', ['blog', 'single']) }}" class="readmore">Read More <i class="fa-light fa-arrow-right"></i></a>
        </div>
      </div>
      ...
      <div class="blog5-boxarea">
        <div class="blog5-imgeas">
        <img src="/img/images/blog3-inner-img6.png" alt="">
        </div>
        <div class="blog5-content-area">
        <div class="tags-area">
          <a href="#">#Child Custody & Support</a>
        </div>
        <a href="{{ route('second', ['blog', 'single']) }}">Expert Criminal Attorneys Law Tailoring Solutions for You</a>
        <p>Child custody is a central concern in many to divorces, We'll explore the different Lawyers.</p>
        <a href="{{ route('second', ['blog', 'single']) }}" class="readmore">Read More <i class="fa-light fa-arrow-right"></i></a>
        </div>
      </div>
