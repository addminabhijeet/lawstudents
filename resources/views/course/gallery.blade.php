    ...
    <div class="nxl-content">
        ...
        <div class="page-header mb-4">
            <div class="page-header-left d-flex align-items-center justify-content-between w-100">
                <div>
                    <h5 class="m-b-5">Gallery Management</h5>
                    <small class="text-muted">Add, edit and manage gallery images</small>
                </div>
            </div>
        </div>
                    ...
                    <form action="{{ isset($editItem) ? route('admin.updategallery', $editItem->id) : route('admin.storegallery') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description"
                                      class="form-control"
                                      rows="3"
                                      placeholder="Enter description...">{{ $editItem->description ?? '' }}</textarea>
                        </div>
