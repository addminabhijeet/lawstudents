      ...
      <div class="row">
        <div class="col-lg-3 m-auto">
          <div class="welcome-inner-header text-center">
            <h1>About Us</h1>
            <a href="<?php echo e(route('any', 'index')); ?>">Home <span><i class="fa-light fa-angle-right"></i></span> About Us</a>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <div class="about-service-content">
            ...
            <div class="div">
              <a href="<?php echo e(route('second', ['service', 'service1'])); ?>" class="casebtn1">Secure Your Defense <span><i class="fa-regular fa-arrow-right"></i></span></a>
            </div>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('layouts.landing' , ['title' => 'Lawsy || Criminal Law || About'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Lawsy\resources\views/pages/about.blade.php ENDPATH**/ ?>