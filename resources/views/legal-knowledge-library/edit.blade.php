        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Edit Legal Knowledge</li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card stretch stretch-full">
                        <div class="card-body">
                            <form action="{{ route('admin.updatelegalknowledgelibrary', $notes->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="category_id" id="category_id" class="form-select" required>
                                        ...
                                        <option value="{{ $category->id }}"
                                            {{ old('category_id', $notes->category_id) == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" class="form-control">{{ old('description', $notes->description) }}</textarea>
                                </div>

                                <button class="btn btn-primary">Update Legal Knowledge</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const oldCat = "{{ old('category_id', $notes->category_id) }}";
        const oldSub = "{{ old('subcategory_id', $notes->subcategory_id) }}";
