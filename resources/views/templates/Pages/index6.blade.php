...
<head>
    <?= $this->element('title_meta' , ['title' => 'Lawsy || Corporate Law' , 'logo11' => true ]) ?>
...
<body>
    ...
    <?= $this->element("loader" , ['loader' => 'preloader7']) ?>

    <?= $this->element("header/navbar6") ?>
                    ...
                    <div class="col-lg-7">
                        <div class="welcome6-header-area">
                            ...
                            <div class="div" data-aos="fade-left" data-aos-duration="1200">
                                <a href="contact1" class="welcome6-btn">Get Legal Help Now <i class="fa-regular fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="welcome6-elements-area">
                            <div class="polygon-author aniamtion-key-1" style="background-image: url(/img/elements/elementor33.svg); background-position: center; background-repeat: no-repeat; background-size: cover; display: inline-block;">
                                <div class="polygon-arrow">
                                    <span><a href="contact1"><i class="fa-regular fa-arrow-right"></i></a></span>
                                    <a href="contact1">Free Case Review</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="about7-header-area">
                        ...
                        <div class="list-about" data-aos="fade-left" data-aos-duration="1100">
                            <ul>
                                <li><a href="#"><img src="/img/icons/check-img7.svg" alt="">Legal Expertise</a></li>
                                <li><a href="#"><img src="/img/icons/check-img7.svg" alt="">Reduced Stress</a></li>
                            </ul>

                            <ul>
                                <li><a href="#"><img src="/img/icons/check-img7.svg" alt="">Paperwork & Documentation</a></li>
                                <li><a href="#"><img src="/img/icons/check-img7.svg" alt="">Child Custody And Support</a></li>
                            </ul>
                        </div>
                        <div class="div" data-aos="fade-left" data-aos-duration="1200">
                            <a href="contact1" class="welcome6-btn">Legal Support Needed<i class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="service7-boxarea">
                            ...
                            <div class="service7-author-area">
                                ...
                                <div class="service-7-content">
                                    <a href="service-single">Auto Accidents</a>
                    ...
                    <div class="service7-box-area">
                        <div class="service7-boxarea">
                            ...
                            <div class="service7-author-area">
                                ...
                                <div class="service-7-content">
                                    <a href="service-single">Workplace Injuries</a>
                                    <div class="service7-content">
                                        <p>Focused Legal Expertise: Our team lawyer specializes in criminal defense best team.</p>
                                        <a href="service-single">Read More <i class="fa-regular fa-arrow-right"></i></a>
                                    </div>
                    ...
                    <div class="service7-box-area">
                        <div class="service7-boxarea">
                            ...
                            <div class="service7-author-area">
                                ...
                                <div class="service-7-content">
                                    <a href="service-single">Medical Malpractice</a>
                                    <div class="service7-content">
                                        <p>Focused Legal Expertise: Our team lawyer specializes in criminal defense best team.</p>
                                        <a href="service-single">Read More <i class="fa-regular fa-arrow-right"></i></a>
                                    </div>
                    ...
                    <div class="service7-box-area">
                        <div class="service7-boxarea">
                            ...
                            <div class="service7-author-area">
                                ...
                                <div class="service-7-content">
                                    <a href="service-single">Slip and Fall Accidents</a>
                                    <div class="service7-content">
                                        <p>Focused Legal Expertise: Our team lawyer specializes in criminal defense best team.</p>
                                        <a href="service-single">Read More <i class="fa-regular fa-arrow-right"></i></a>
                                    </div>
                    ...
                    <div class="service7-box-area">
                        <div class="service7-boxarea">
                            ...
                            <div class="service7-author-area">
                                ...
                                <div class="service-7-content">
                                    <a href="service-single">Product Liability</a>
                                    <div class="service7-content">
                                        <p>Focused Legal Expertise: Our team lawyer specializes in criminal defense best team.</p>
                                        <a href="service-single">Read More <i class="fa-regular fa-arrow-right"></i></a>
                                    </div>
                    ...
                    <div class="service7-box-area">
                        <div class="service7-boxarea">
                            ...
                            <div class="service7-author-area">
                                ...
                                <div class="service-7-content">
                                    <a href="service-single">Wrongful Death</a>
                                    <div class="service7-content">
                                        <p>Focused Legal Expertise: Our team lawyer specializes in criminal defense best team.</p>
                                        <a href="service-single">Read More <i class="fa-regular fa-arrow-right"></i></a>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="work-author-box" data-aos="fade-right" data-aos-duration="1000">
                                <div class="work-content">
                                    <a href="service-single">Consultation & Assessment</a>
                        ...
                        <div class="col-lg-12">
                            <div class="work-author-box" data-aos="fade-right" data-aos-duration="1200">
                                <div class="work-content">
                                    <a href="service-single">Tailored Legal Strategies</a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="work-author-box box2" data-aos="fade-left" data-aos-duration="1000">
                                <div class="work-content">
                                    <a href="service-single">Implementation Execution</a>
                        ...
                        <div class="col-lg-12">
                            <div class="work-author-box box2" data-aos="fade-left" data-aos-duration="1200">
                                <div class="work-content">
                                    <a href="service-single">Our Legal Support</a>
                    ...
                    <div class="casestudy-carousel-area owl-carousel">
                        <div class="case7-study-area">
                            <div class="case-study7-boxarea">
                                ...
                                <div class="polygon-author" style="background-image: url(/img/elements/elementor33.svg); background-position: center; background-repeat: no-repeat; background-size: cover; display: inline-block;">
                                    <div class="polygon-arrow">
                                        <span><a href="blog-single"><i class="fa-regular fa-arrow-right"></i></a></span>
                                        <a href="blog-single">Read More</a>
                                    </div>
                                </div>
                                <div class="case-study-carousel-content text-center">
                                    <a href="blog-single">Precision Legal Counsel</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="case7-study-area">
                            <div class="case-study7-boxarea">
                                ...
                                <div class="case-study-carousel-content text-center">
                                    <a href="blog-single">Vanguard Legal Advocates</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="case7-study-area">
                            <div class="case-study7-boxarea">
                                ...
                                <div class="case-study-carousel-content text-center">
                                    <a href="blog-single">Paramount Legal Services</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="case7-study-area">
                            <div class="case-study7-boxarea">
                                ...
                                <div class="case-study-carousel-content text-center">
                                    <a href="blog-single">Elite Counsel Solutions</a>
                                </div>
                            </div>
                        </div>
                        <div class="case7-study-area">
            ...
            <div class="row">
                    ...
                    <div class="blog7-box-area" data-aos="zoom-in" data-aos-duration="1000">
                        ...
                        <div class="blog7-textarea">
                            ...
                            <div class="blog-arrow">
                                <a href="blog-single"><i class="fa-regular fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="blog7-box-area" data-aos="zoom-in" data-aos-duration="1200">
                        ...
                        <div class="blog7-textarea">
                            ...
                            <a href="blog-single">The Law Unfolded: Expert Commentary & Guidance</a>
                            <p>The world of law is constantly evolving, and staying informed is best crucial. Our blog acts as your compass in this ever-changing legal.</p>
                            <a href="blog-single" class="readmore">Read More <i class="fa-regular fa-arrow-right"></i></a>
                            <div class="blog-arrow">
                                <a href="blog-single"><i class="fa-regular fa-arrow-right"></i></a>
                ...
                <div class="col-lg-12" data-aos="fade-up" data-aos-duration="1200">
                    <div class="div text-center">
                        <a href="blog1" class="welcome6-btn">Read More Blog & News <i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
