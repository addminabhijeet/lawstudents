...
@section('body_attribute')
  class="rtl-homege-area"
@endsection

@section('content')
  @include('layouts.partials.loader', ['loader' => 'preloader4'])

  @include('layouts.partials.header.navbar-rtl')
  ...
  <div class="welcome2-section-area">
    ...
    <div class="row align-items-center">
      ...
      <div class="welcome-header2-text">
        ...
        <a href="{{ route('second', ['contact', 'v1']) }}" class="welconme-btn2">Download Tax Guides <span><i class="fa-regular fa-angle-left"></i></span></a>
        </div>
      </div>
      </div>
      <div class="col-lg-6">
  ...
  <div class="about-section-area sp1">
    ...
    <div class="row align-items-center">
      ...
      <div class="about2-textarea">
        ...
        <a href="{{ route('second', ['pages', 'about']) }}" class="welconme-btn2">About Us <span><i class="fa-regular fa-angle-left"></i></span></a>
        </div>
      </div>
      </div>
    </div>
  ...
  <div class="service2-section-area sp3">
    ...
    <div class="row align-items-center">
      ...
      <div class="service2-header-text">
        ...
        <a href="{{ route('second', ['service', 'service1']) }}" class="welconme-btn2">View Our Services <span><i class="fa-regular fa-angle-left"></i></span></a>
        </div>
      </div>
      </div>
      <div class="col-lg-8">
      <div class="service2-boxarea">
        ...
        <div class="col-lg-6 col-md-6" data-aos="zoom-out" data-aos-duration="800">
          ...
          <a href="{{ route('second', ['service', 'single']) }}" class="learn-more">Learn More<i class="fa-light fa-arrow-left"></i></a>
  ...
  <div class="testimonial2-section-area sp1">
    ...
    <div class="row align-items-center">
      ...
      <div class="testimonial2-header">
        <span data-aos="fade-left" data-aos-duration="600">Testimonials</span>
  ...
  <div class="blog1-section-area blog2-section sp1">
    ...
    <div class="row">
      ...
      <div class="blog-boxarea">
        ...
        <a href="{{ route('second', ['blog', 'single']) }}" class="readmore">Read More <i class="fa-light fa-arrow-left"></i></a>
        </div>
      </div>
      </div>
    ...
    <div class="col-lg-12" data-aos="fade-up" data-aos-duration="1400">
      ...
      <a href="{{ route('second', ['blog', 'single']) }}" class="welconme-btn2">Read More Blog & Articles <span><i class="fa-regular fa-angle-left"></i></span></a>
      </div>
    </div>
    </div>
  </div>
