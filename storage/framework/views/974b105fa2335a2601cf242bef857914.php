                                    ...
                                    <div class="top-content-area">
                                        <div class="content">
                                            <p style="margin: 0; word-break: break-word; overflow-wrap: break-word;">Start your journey into the world of law today.<a
                                                    href="<?php echo e(route('frontend.contact')); ?>">Contact Us</a></p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <ul style="display:flex; align-items:center; margin:0; padding:0; white-space: nowrap;">
                                            <li style="list-style:none;">
                                                <a href="mailto:<?php echo e($email); ?>"
                                                    ...
                                                    <span style="overflow: hidden; text-overflow: ellipsis;"><?php echo e($email); ?></span>
                                                </a>
                                            </li>
                                        </ul>
                        ...
                        <div class="header-elements" style="display: flex; align-items: center; justify-content: space-between; width: 100%; gap: 15px; flex-wrap: nowrap;">
                            ...
                            <div class="main-menu-ex homepage6" style="flex: 1; min-width: 0; overflow: hidden;">
                                <ul style="display: flex; flex-wrap: nowrap; align-items: center; gap: 0px; margin: 0; padding: 0; list-style: none;">
                                    <li style="list-style: none; flex-shrink: 0;"><a href="<?php echo e(route('frontend.home')); ?>" class=" mainhome" style="white-space: nowrap;">Home</a></li>
                                    <li style="list-style: none; flex-shrink: 0;"><a href="<?php echo e(route('frontend.about')); ?>" style="white-space: nowrap;">About Us</a></li>
                                    <li style="list-style: none; flex-shrink: 0;"><a href="<?php echo e(route('frontend.acts')); ?>" style="white-space: nowrap;">Acts</a></li>
                                    <li style="list-style: none; flex-shrink: 0;"><a href="<?php echo e(route('frontend.rules')); ?>" style="white-space: nowrap;">Rules</a></li>
                                    <li style="list-style: none; flex-shrink: 0;"><a href="<?php echo e(route('frontend.copys')); ?>" style="white-space: nowrap;">Free Notes</a></li>
                                    <li style="list-style: none; flex-shrink: 0;"><a href="<?php echo e(route('frontend.clientele')); ?>" style="white-space: nowrap;">Client</a></li>
                                    <li style="list-style: none; flex-shrink: 0;"><a href="<?php echo e(route('frontend.course')); ?>" style="white-space: nowrap;">Course</a></li>
                                    <li style="list-style: none; flex-shrink: 0;"><a href="<?php echo e(route('frontend.gallery')); ?>" style="white-space: nowrap;">Gallery</a></li>
                                    <li style="list-style: none; flex-shrink: 0;"><a href="<?php echo e(route('frontend.contact')); ?>" style="white-space: nowrap;">Contact Us</a></li>
                            ...
                            <aside class="slide-bar slide-bar6">
                                ...
                                <div class="sidebar-info sidebar-info6">
                                    ...
                                    <ul class="social-links">
                                        ...
                                        <li><a href="<?php echo e($facebook); ?>"><i class="fa-brands fa-facebook"></i></a>
                                        </li>
                                        ...
                                        <li><a href="<?php echo e($pinterest); ?>"><i class="fa-brands fa-pinterest"></i></a>
                                        </li>
                                    </ul>
                                </div>
...
<!--===== MOBILE HEADER ENDS =======-->
<?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/layouts/partials/header/navbar.blade.php ENDPATH**/ ?>