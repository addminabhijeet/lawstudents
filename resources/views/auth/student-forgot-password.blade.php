...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Law Students || Reset Minimal</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    ...
                    <div class="card-body p-sm-5">
                        ...
                        <p class="fs-12 fw-medium text-muted">Enter your email or username and we will send the next password reset step.</p>
                        <p class="mb-4"><a href="{{ route('frontend.home') }}" class="fs-12 fw-bold text-primary">Back to Website</a></p>
                        @if ($errors->any())
                        ...
                        @endif
                        <form method="POST" action="{{ route('student.send-otp') }}" class="w-100 mt-4 pt-2">
                            @csrf
                            <div class="mb-4">
