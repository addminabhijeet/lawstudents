            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    ...
                    <div class="card-body p-sm-5">
                        ...
                        <form action="<?php echo e(route('login.submit')); ?>" method="POST" class="w-100 mt-4 pt-2">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    <a href="<?php echo e(route('student.forgot')); ?>" class="fs-11 text-primary">Forget
                                        password?</a>
                                </div>
                            </div>
...
<?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/auth/auth-login-minimal.blade.php ENDPATH**/ ?>