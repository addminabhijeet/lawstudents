                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="items[{{ $index }}][product]"
                                                        class="form-control" value="{{ $item['product'] ?? '' }}">
                                                </td>

                                                <td>
                                                    <input type="number" name="items[{{ $index }}][qty]"
                                                        class="form-control qty" value="{{ $item['qty'] ?? 1 }}">
                                                </td>

                                                <td>
                                                    <input type="number" name="items[{{ $index }}][price]"
                                                        class="form-control price" value="{{ $item['price'] ?? 0 }}">
                                                </td>
                            ...
                            <table class="table table-bordered" id="tab_logic_total">
                                <tbody>
                                    <tr class="single-item">
                                        ...
                                        <td class="w-25"><input type="number" name="sub_total" id="sub_total"
                                                value="{{ old('sub_total', $payment->sub_total) }}" readonly></td>
                                    </tr>
                                    <tr class="single-item">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content mt-4">
                            ...
                            <div class="tab-pane fade" id="pamymetPaypalTab" role="tabpanel">
                                ...
                                <div class="fs-11 text-muted">Note: There are many variations of passages of Lorem
                                    Ipsum
                ...
                <div class="card stretch stretch-full">
                    <div class="card-body">
                        <div class="mb-4 d-flex align-items-center justify-content-between">
                            ...
                            <div class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                title="Calculate your currency, tax & discount">
                                <i class="feather feather-info"></i>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <input class="form-check-input" type="checkbox" name="save_payment" value="1"
                                {{ $payment->save_payment ? 'checked' : '' }}>
                        </div>
                    </div>
                </div>
                <div class="card stretch stretch-full">
                    <div class="card-body">
                        ...
                        <p class="fs-12 text-muted mb-4">Are you sure you want to cancel this invoice? Neigther you nor
                        ...
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label c-pointer" for="notifyMe">Notify alex that this invoice
                                was
                                cancelled.</label>
                        </div>
                        <a href="javascript:void(0);"
                            class="btn bg-soft-danger text-danger mt-4 successAlertMessage">Cancel this Invoice</a>
                    </div>
                </div>
            </div>
