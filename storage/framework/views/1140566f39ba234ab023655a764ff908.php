                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-lg-6">
                                            ...
                                            <p class="mb-0 fw-semibold"><?php echo e(old('email', $student->email ?? '')); ?></p>
                                        </div>

                                        <div class="col-lg-6">
                                            <label class="text-muted small mb-1">Password</label>
                                            <p class="mb-0 fw-semibold"><?php echo e($defaultpassword); ?></p>
                                        </div>
                                    </div>
...
<?php /**PATH /home/u792878158/domains/law.norloxsolutionscrm.com/public_html/resources/views/student/view.blade.php ENDPATH**/ ?>